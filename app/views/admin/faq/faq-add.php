...
<head>
    ...
    <title>افزودن سوال جدید | <?= $data['getPublicInfo']['site']; ?></title>
    <!-- Favicon -->
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Question Add</li>
            </ol>
        </section>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-warning">
                        <div class="box-header with-border">
                            <h3 class="box-title">ثبت سوال جدید</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <div class="box-body">
                                <div class='row'>
                                    <div class='col-md-4'>
                                        <div class="form-group" style="text-align:right">
                                            ...
                                            <select style="width: 100%;" id="type" name="type" class="form-control select2Class" style="border-radius: 3px;width: 100%;direction: rtl">
                                                <option selected data-id="public" value="public">عمومی</option>
                                    ...
                                    <div data-intro="سوال را در این بخش می توانید وارد نمایید." class='col-md-8'>
                                        <div class="form-group" style="text-align:right">
                                            ...
                                            <input style="border-radius: 3px;text-align:right" type="text" class="form-control" id="question" name="question" required>
                                        </div>
                                    </div>

                                    <div id="servicesPart" style="display: none" class='col-md-12'>
                                        <div class="form-group" style="text-align:right">
                                            ...
                                            <select id="services" name="services[]" class="form-control select2Class" style="width: 100%;direction: ltr;" multiple="multiple">
                                                <?php foreach($data['services'] as $service){ ?>
                                                    <option data-id="<?= $service['s_id'] ?>" value="<?= $service['s_id'] ?>"><?= $service['s_title'] ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div data-intro="در این بخش می توانید پاسخ سوال را به همراه تصویر و... وارد نمایید" class='col-md-12'>
                                        <div class="form-group" style="text-align:right">
                                            ...
                                            <textarea style="border-radius: 3px;resize: vertical;text-align:right" class="form-control" rows="8" id="answer" name="answer" required></textarea>
                                        </div>
                                    </div>
                                </div>
                                <!-- /.box-body -->
...
<script>
    CKEDITOR.plugins.addExternal('video', '<?= URL; ?>public/panel/plugins/ckeditor4-major/plugins/video/', 'plugin.js');
    CKEDITOR.plugins.addExternal('autosave', '<?= URL; ?>public/panel/plugins/ckeditor4-major/plugins/autosave/', 'plugin.js');
    CKEDITOR.plugins.addExternal('html5audio', '<?= URL; ?>public/panel/plugins/ckeditor4-major/plugins/html5audio/', 'plugin.js');
            ...
            if (navigator.onLine) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data.status == "ok") {
                            window.location.href = '<?= ADMIN_PATH; ?>/faq';
                        }
                    },
                });
            } else {
