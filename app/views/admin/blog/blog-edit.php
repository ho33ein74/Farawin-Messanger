...
<head>
    ...
    <title>ویرایش مطلب <?= $blogInfo['0']['title']; ?> | <?= $data['getPublicInfo']['site']; ?></title>
    <!-- Favicon -->
                                        ...
                                        <div class='row'>
                                            <div data-intro="در این بخش می توانید عنوان مطلب را وارد نمایید" class='col-md-6'>
                                                <div class="form-group" style="text-align:right">
                                                    ...
                                                    <input style="border-radius: 3px;text-align:right" type="text" value="<?= $blogInfo['0']['title']; ?>"
                                                ...
                                                <div class="form-group" style="text-align:right">
                                                    ...
                                                    <select id="category" name="category" class="form-control"
                                                        ...
                                                        foreach ($categories as $category) {
                                                            ?>
                                                            <option <?= $blogInfo['0']['cat_id'] == $category['id'] ? "selected='selected'" : "" ?> value="<?= $category['id']; ?>"><?= $category['name']; ?></option>
                                                            <?php
                                                        }
                                                        ?>
                                                    </select>
                                                ...
                                                <div class="form-group" style="text-align:right">
                                                    ...
                                                    <select id="source" name="source" class="form-control"
                                                        ...
                                                        foreach ($sources as $source) {
                                                            ?>
                                                            <option <?= $blogInfo['0']['source'] == $source['so_id'] ? "selected='selected'" : "" ?> value="<?= $source['so_id']; ?>"><?= $source['title']; ?></option>
                                                            <?php
                                                        }
                                                        ?>
                                                    </select>
                                            ...
                                            <div class='col-md-12'>
                                                <div class="form-group" style="text-align:right">
                                                    <div class="custom-checkbox">
                                                        <input <?= $blogInfo['0']['slug'] != str_replace(" ","-",$blogInfo['0']['title']) ? "checked":"" ?> type="checkbox" name="edit-url" id="edit-url">
                                                        <label class="mt-1 mr-3" for="edit-url">مایل به اصلاح دستی لینک محصول هستید؟</label>
                                                    </div>
                                                </div>
                                            </div>

                                            <div class='col-md-12'>
                                                <div class="form-group" style="<?= $blogInfo['0']['slug'] != str_replace(" ","-",$blogInfo['0']['title']) ? "display: block;":"display: none;" ?>" id="edit-url-manual">
                                                    <label>پیوند محصول (لینک)</label>
                                                    <input type="text" class="form-control" value="<?= $blogInfo['0']['slug'] ?>" id="url" name="url" placeholder="لینک را بنویسید...">
                                                </div>
                                            </div>
                                            ...
                                            <div data-intro="در این بخش محتوای مطلب را می توانید اضافه نمایید که با استفاده از ابزاری که در نظر گرفته شده می توانید اندازه متن، رنگ و... را تغییر دهید." class='col-md-12'>
                                                <div class="form-group" style="text-align:right">
                                                    ...
                                                    <textarea style="border-radius: 3px;resize: vertical;text-align:right" class="form-control" rows="8" id="desc" name="desc" required><?= $blogInfo['0']['description']; ?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div data-intro="خلاصه ای از مطلب در حد یک پاراگراف می توانید در این بخش بنویسید، که این خلاصه به عنوان متا تگ توضیحات نیز استفاده می شود." class='col-md-6'>
                                                <div class="form-group" style="text-align:right">
                                                    <label style="width: 100%" align="right" for="subtitle">:خلاصه
                                                        مطلب</label>
                                                    <textarea style="border-radius: 3px;resize: vertical;text-align:right" class="form-control" rows="8" id="subtitle" name="subtitle"><?= $blogInfo['0']['subtitle']; ?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class='col-md-6'>
                                                <div data-intro="چنانچه مطبی که منتشر می کنید از جای دیگری استفاده کرده اید می توانید لینک آن را در این بخش بنویسید." class='col-md-12'>
                                                    <div class="form-group" style="text-align:right">
                                                        ...
                                                        <input style="border-radius: 3px;text-align:left" type="text" value="<?= $blogInfo['0']['link']; ?>" class="form-control" id="linkSource" name="linkSource">
                                                    </div>
                                                </div>
                                                ...
                                                <div data-intro="از بین دسته بندی های موجود می بایست یک دسته بندی را انتخاب نمایید. برای افزودن یا ویرایش دسته بندی ها می توانید از بخش دسته بندی اقدام نمایید." class='col-md-12'>
                                                    <div class="form-group" style="text-align:right">
                                                        ...
                                                        <select id="suggestion" name="suggestion" class="form-control" style="border-radius: 3px;width: 100%;direction: rtl" required>
                                                            <option <?= $blogInfo['0']['suggestion']==1 ? "selected":""; ?> value="1">بله</option>
                                                            <option <?= $blogInfo['0']['suggestion']==0 ? "selected":""; ?> value="0">خیر</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="card-body">
                                                <div class='col-md-4'>
                                                    <div class="form-group" style="text-align:right">
                                                        ...
                                                        <input style="border-radius: 3px;text-align:right" value="<?= $blogInfo['0']['main_tag'] ?>" type="text" class="form-control" id="mainKeyword" name="mainKeyword">
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group" style="text-align:right">
                                                        ...
                                                        <select id="tags" multiple="multiple" name="tags" class="form-control select2" style="width: 100%;direction: ltr;text-align: start;unicode-bidi: plaintext;">
                                                            <?php foreach($data['tag'] as $tag){ ?>
                                                                <option <?= in_array($tag['t_id'], $data['postTag']) ? "selected":"" ?> data-id="<?= $tag['t_id'] ?>" value="<?= $tag['tag'] ?>">
                                                                    <?= $tag['tag'] ?>
                                                                </option>
                                                            <?php }?>
                                                        </select>
                                                ...
                                                <div class='col-md-12'>
                                                    <div class="form-group">
                                                        <label>عنوان</label>
                                                        <input type="text" value="<?= $blogInfo['0']['seo_title'] ?>" id="seo_title" name="seo_title" class="form-control">
                                                    </div>
                                                </div>
                                                ...
                                                <div class='col-md-12'>
                                                    <div class="form-group">
                                                        ...
                                                        <textarea maxlength="150" class="form-control" id="seo_desc" name="seo_desc" rows="3" placeholder="توضیحی درج نمایید..."><?= $blogInfo['0']['seo_desc'] ?></textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12 seo-box">
                                                    <a href="blog/article/<?= $blogInfo['0']['slug'] ?>" target="_blank" class="seo-title" id="preview_seo_title"><?= $blogInfo['0']['seo_title'] ?></a>
                                                    <a href="blog/article/<?= $blogInfo['0']['slug'] ?>" target="_blank" class="link" id="preview_seo_link"><?= URL ?>blog/article/<?= $blogInfo['0']['slug'] ?></a>
                                                    <div style="direction: rtl;">
                                                        <span class="date"><?= jdate("j F Y"); ?> -</span>
                                                        <span class="seo-description" id="preview_seo_desc"><?= $blogInfo['0']['seo_desc'] ?></span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="col-md-3">
                        ...
                        <div class="box-body text-center">
                            ...
                            <div data-intro="وضعیت مطلب را می توانید از این بخش انتخاب نمایید. با انتخاب گزینه فعال مطلب در سایت نمایش داده خواهد شد و گزینه غیرفعال مطلب به صورت پیش نویس ذخیره می شود." class="form-group text-right">
                                ...
                                <select class="form-control" id="status" name="status" style="width: 100%;" tabindex="-1" aria-hidden="true">
                                    <option <?= $blogInfo['0']['b_status'] == 1 ? "selected='selected'" : "" ?> value="1">فعال</option>
                                    <option <?= $blogInfo['0']['b_status'] == 0 ? "selected='selected'" : "" ?> value="0">غیرفعال</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div data-intro="در این بخش عکس کاور مطلب را می توانید انتخاب نمایید. تا حد امکان سعی کنید که حجم تصویر زیاد نباشد تا باعث کند شدن لود صفحه نگردد." class="box box-info">
                        ...
                        <div class="file-upload">
                            <div style="display: <?= $blogInfo['0']['cover']!="" ? "none":"block" ?>;" class="image-upload-wrap">
                            ...
                            <div style="display: <?= $blogInfo['0']['cover']!="" ? "block":"none" ?>;" class="file-upload-content">
                                <img class="file-upload-image" src="public/images/blog/<?= $blogInfo['0']['cover']; ?>" alt="your image">
