...
<head>
    ...
    <title>لیست کاربران استفاده کننده کد <?= $data['discountsInfo']['0']['dc_title'] ?> | <?= $data['getPublicInfo']['site']; ?></title>
    <!-- Favicon -->
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                <small>لیست کاربران استفاده کننده کد <?= $data['discountsInfo']['0']['dc_title'] ?></small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="<?= URL; ?><?= ADMIN_PATH; ?>/dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
                <li><a href="<?= URL; ?><?= ADMIN_PATH; ?>/discounts"><i class="fa fa-quote-right"></i> Discounts</a></li>
                <li class="active">User used discount</li>
            </ol>
        </section>
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">لیست کاربران استفاده کننده کد <?= $data['discountsInfo']['0']['dc_title'] ?></h3>
                        </div>
                        <!-- /.box-header -->
                        <div data-step="1" data-intro="در این بخش لیست کاربرانی که از کد تخفیف استفاده کرده اند نمایش داده می شود که به نکات زیر توجه نمایید:<br/><br/>1- برای گرفتن خروجی می توانید از دکمه های خروجی اکسل و یا خروجی csv بسته به نیاز استفاده نمایید.<br/><br/>2- برای پرینت اطلاعات می توانید از دکمه پرینت استفاده نمایید.<br/><br/>3- در صورتی که در هنگام گرفتن خروجی یا پرینت خواستید ستونی نمایش داده نشود می توانید از بخش فیلتر ستون ها، ستون مورد نظر خود را غیرفعال نمایید تا در خروجی مورد نظر نمایش داده نشود<br/><br/>4- به علت افزایش سرعت لود اطلاعات، اطلاعات به صورت محدود از دیتابیس خوانده می شود در صورتی که می خواهید لیست کامل اطلاعات را خروجی بگیرید کافیست از قسمت نمایش در پایین جدول گزینه همه را انتخاب و سپس اقدام به گرفتن خروجی نمایید.<br/><br/>5- برای جستجو و فیلتر کردن اطلاعات می توانید از فیلدهای موجود در زیر عنوان هر ستون استفاده نمایید و در صورت تمایل می توانید به صورت همزمان چند ستون را فیلتر نمایید تا اطلاعات مد نظر شما نمایش داده شود." class="box-body">
                            <div class="table-responsive direction">
                                <table id="example1" class="table table-bordered table-striped" style="width: 100%">
                                    ...
                                    <tr>
                                        ...
                                        <th class="priority-1" style="text-align:center;width: 100px">تاریخ استفاده</th>
    ...
    $(function () {
        ...
        var table = $('#example1').DataTable({
            ...
            "columnDefs": [
                ...
                {className: "priority-1", "targets": [0, 1, 3, 4]},
                {className: "priority-2", "targets": [2]}
            ],
            "ajax": $.fn.dataTable.pipeline({
                url: '<?= ADMIN_PATH; ?>/getDiscountsUsersAjax?id=<?= $data['attrId'] ?>',
                pages: 5
            }), initComplete: function () {
                this.api().columns(3).every(function () {
                    var column = this;
                    var select = $('<select><option value="0" disabled="" selected="" hidden="">انتخاب وضعیت</option><option value="">همه موارد</option><option value="2">استفاده شده</option><option value="1">موفق</option><option value="0">ناموفق</option></select>')
...
<script>
    ...
    $(document).on("click", "#delete-submit", function () {
        ...
        if (navigator.onLine) {
            ...
            $.ajax({
                url: "<?= ADMIN_PATH; ?>/delDiscountsUser",
                data: formData,
                type: "POST",
                processData: false,
                contentType: false,
