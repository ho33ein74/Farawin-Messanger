...
<head>
    ...
    <title>ثبت نوبت جدید | <?= $data['getPublicInfo']['site']; ?></title>
    <!-- Favicon -->
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"> Add new booked</li>
            </ol>
        </section>


        <?php if($data['publicData']['request']['branches']){  ?>
            <div class="col-lg-12 col-xs-12 mt-5">
                <div style="direction: rtl" class="alert alert-danger callout callout-danger alert-dismissible">
                    ...
                    برای استفاده از این بخش ابتدا از بخش افزودن شعبه، حداقل یک شعبه ثبت نمایید.
                </div>
            </div>
        <?php } ?>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-warning">
                        <div class="box-header with-border">
                            <h3 class="box-title">ثبت نوبت جدید</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <div class="box-body">
                                        ...
                                        <div class="cu personal-pro ajaxform">
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="form-group" style="text-align:right">
                                                        ...
                                                        <select id="Customer" name="Customer" class="form-control" style="width: 100%;direction: ltr;text-align: start;unicode-bidi: plaintext;">
                                                            ...
                                                            <?php foreach ($data['userGetLatest'] as $getUser) { ?>
                                                                <option value="<?= $getUser['customer_vids_id']; ?>" id="customer-<?= $getUser['customer_vids_id']; ?>" data-num="<?= $getUser['c_mobile_num']; ?>" data-fname="<?= $getUser['c_name']; ?>" data-lname="<?= $getUser['c_family']; ?>" data-mask="<?= $getUser['c_phone_num']; ?>"><?= $getUser['c_arithmetic']==1 ? "🟢":"🔴"; ?> <?= $getUser['c_display_name']; ?> - <?= $getUser['c_mobile_num']; ?></option>
                                                            <?php } ?>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group" style="text-align:right">
                                                        <div class="input text">
                                                            ...
                                                            <input id="CustomerName" type="text" name="CustomerName" class="form-control" style="text-align: start;unicode-bidi: plaintext;border-radius: 3px;width: 100%;direction: rtl" required="">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group" style="text-align:right">
                                                        <div class="input text">
                                                            ...
                                                            <input id="CustomerFamily" type="text" name="CustomerFamily" class="form-control" style="text-align: start;unicode-bidi: plaintext;border-radius: 3px;width: 100%;direction: rtl" required="">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group" style="text-align:right">
                                                        <div class="input text">
                                                            ...
                                                            <input id="CustomerNumber" type="text" name="CustomerNumber" class="form-control" style="text-align: start;unicode-bidi: plaintext;border-radius: 3px;width: 100%;direction: rtl" required="">
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group" style="text-align:right">
                                                        <div class="input text">
                                                            ...
                                                            <input id="CustomerPhone" type="text"
                                                                   name="CustomerPhone"
                                                                   class="form-control" style="text-align: start;unicode-bidi: plaintext;border-radius: 3px;width: 100%;direction: rtl" required="">
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group" style="text-align:right">
                                                        ...
                                                        <select id="service" name="service" class="form-control select2Class" style="width: 100%;direction: ltr;text-align: start;unicode-bidi: plaintext;">
                                                            ...
                                                            <?php foreach ($data['services'] as $service) { ?>
                                                                <option value="<?= $service['s_id']; ?>"><?= $service['s_title']; ?></option>
                                                            <?php } ?>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group" style="text-align:right">
                                                        <div class="input text">
                                                            ...
                                                            <input id="dateSelected" type="text" name="dateSelected" class="form-control" readonly style="text-align: start;unicode-bidi: plaintext;border-radius: 3px;width: 100%;direction: rtl" required="">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group" style="text-align:right">
                                                        <div class="input text">
                                                            ...
                                                            <input id="timeSelected" type="text" name="timeSelected" class="form-control" readonly style="text-align: start;unicode-bidi: plaintext;border-radius: 3px;width: 100%;direction: rtl" required="">
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group" style="text-align:right">
                                                        ...
                                                        <select id="branch" name="branch" class="form-control select2Class" style="width: 100%;direction: ltr;text-align: start;unicode-bidi: plaintext;">
                                                            ...
                                                            <?php foreach ($data['getBranches'] as $branch) { ?>
                                                                <option <?= sizeof($data['getBranches']) == 1 ? "selected":""; ?> data-id="<?= $branch['branch_vids_id']; ?>" value="<?= $branch['branch_vids_id']; ?>"><?= $branch['b_name']; ?></option>
                                                            <?php } ?>
                                                        </select>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group" style="text-align:right">
                                                        <div class="input text">
                                                            ...
                                                            <div class="input-group AddCommaToPrice">
                                                                <input style="border-radius: 0 3px 3px 0;text-align:left;direction: ltr;" readonly type="text" class="form-control" id="priceService" name="priceService" required="">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group" style="text-align:right">
                                                        <div class="input text">
                                                            ...
                                                            <div class="input-group AddCommaToPrice">
                                                                <input style="border-radius: 0 3px 3px 0;text-align:left;direction: ltr;" readonly type="text" class="form-control" id="depositService" name="depositService" required="">
                                                                <span style="border-radius: 3px 0 0 3px;" class="input-group-addon">تومان</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group" style="text-align:right">
                                                        <div class="input text">
                                                            <label for="status" class="">:وضعیت نوبت</label>
                                                            <select id="status" name="status" class="form-control" style="border-radius: 3px;width: 100%;direction: rtl" required>
                                            ...
                                            <div  data-step="6" data-intro="در این بخش اطلاعات پرداخت و وضعیت نوبت را می توانید مشخص نمایید." class="row">
                                                <div class="col-md-3">
                                                    <div class="form-group" style="text-align:right">
                                                        <div class="input text">
                                                            <label for="deposit" class="">:مبلغ پرداختی</label>
                                                            <div class="input-group AddCommaToPrice" id="priceID">
                                                                <input style="border-radius: 0 3px 3px 0;text-align:left;direction: ltr;" type="text"
                                                                       class="form-control" id="deposit" name="deposit" required="">
                                                                <span style="border-radius: 3px 0 0 3px;" class="input-group-addon">تومان</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group" style="text-align:right">
                                                        <div class="input text">
                                                            <label for="afterpay" class="">:شماره پیگیری پرداخت</label>
                                                            <input style="border-radius: 0 3px 3px 0;text-align:left;direction: ltr;" type="text"
                                                                   class="form-control" id="afterpay" name="afterpay" required="">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class='col-md-3'>
                                                    <div class="form-group" style="text-align:right">
                                                        ...
                                                        <select id="order_typePay" name="order_typePay" class="form-control" style="border-radius: 3px;width: 100%;" required>
                                            ...
                                            <div data-step="7" data-intro="بعد از تکمیل فرم با استفاده از این دکمه می توانید اطلاعات را ثبت نمایید.<br/>فقط توجه داشته باشید که برای ثبت موفقیت آمیز اطلاعات حتما باید اینترنت شما وصل باشد." class="box-footer">
    ...
    function getPaymentType(th) {
        if (navigator.onLine) {
            jQuery.ajax({
                ...
                headers: {"Content-type": "application/json"},
                success: function (json) {
                    $('#'+th.id.replace('order_type','order_typePay')).html('');
                    $.each(json, function (key, value) {
                        $('#'+th.id.replace('order_type','order_typePay')).append($('<option>', {
                            value: value.id,
                            text: value.name
                        }));
                    });
            ...
            $.wnoty({type: 'error', message: 'وضعیت شما آفلاین می باشد و امکان دریافت مقادیر مقصد وجود ندارد.'});
        }
    }
...
<script type="text/javascript">
    function calculatePrice( value ) {
        var row = $(value).closest('.repeaterClass');
        $(row).find(".product-priceAll").val($(row).find(".product-count").val() * $(row).find(".product-price").val());
        calculateAllPrice();
    }

    function calculateAllPrice() {
        var sum = 0;
        $(".product-priceAll").each(function () {
            sum += +$(this).val();
        });
        $("#deposit").val(numberWithCommas(sum));
    }
</script>
...
<script>
    $("#btn-submit").on('click', function () {
        ...
        var afterpay = document.getElementById("afterpay").value;
        ...
        if (branch == "") {
            ...
            $.wnoty({type: 'warning', message: 'وضعیت نوبت را انتخاب کنید.'});
        } else if (is_vip == "") {
            ...
            if (navigator.onLine) {
                ...
                formData.append("afterpay", afterpay);
                formData.append("order_type", order_type);
                formData.append("order_typePay", order_typePay);

                $.ajax({
                    url: "<?= ADMIN_PATH; ?>/newBooking",
                    data: formData,
                    type: "POST",
                    processData: false,
                    contentType: false,
