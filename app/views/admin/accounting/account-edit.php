...
<head>
    ...
    <title>ویرایش اطلاعات بانک <?= $data['bankInfo']['0']['b_name']; ?> | <?= $data['getPublicInfo']['site']; ?></title>
    <!-- Favicon -->
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                <small>ویرایش اطلاعات بانک <?= $data['bankInfo']['0']['b_name']; ?></small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="<?= URL; ?><?= ADMIN_PATH; ?>/dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
                <li><a href="<?= URL; ?><?= ADMIN_PATH; ?>/accounts/add"><i class="fa fa-bank"></i> Banks</a></li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-warning">
                        <div class="box-header with-border">
                            <h3 class="box-title">ویرایش اطلاعات بانک <?= $data['bankInfo']['0']['b_name']; ?></h3>
                        </div>
                        <!-- /.box-header -->
                        <div data-step="1" data-intro="برای ویرایش اطلاعات حساب بانکی به راحتی می توانید بخش مورد نظر خود را ویرایش کنید.<br/>توجه داشته باشید صحت شماره کارت و شماره شبا بررسی می شود و در صورت اشتباه بودن امکان ویرایش وجود ندارد." class="box-body">
                            <div class="box-body">
                                <div class='row'>
                                    <div class='col-md-4'>
                                        <div class="form-group" style="text-align:right">
                                            <label style="width: 100%;" align="right" for="name">:نام بانک</label>
                                            <input style="border-radius: 3px;text-align:right" type="text" value="<?= $data['bankInfo']['0']['b_name']; ?>"
                                    ...
                                    <div class='col-md-3'>
                                        <div class="form-group" style="text-align:right">
                                            ...
                                            <input style="border-radius: 3px;text-align:right" type="text" value="<?= $data['bankInfo']['0']['b_branch']; ?>"
                                    ...
                                    <div class='col-md-2'>
                                        <div class="form-group" style="text-align:right">
                                            ...
                                            <select id="default_bank" name="default_bank" class="form-control"
                                                    ...
                                                    required>
                                                <option <?= 1==$data['bankInfo']['0']['b_default'] ?"selected='selected'":""; ?> value="1" selected="selected">بله</option>
                                                <option <?= 0==$data['bankInfo']['0']['b_default'] ?"selected='selected'":""; ?> value="0">خیر</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class='col-md-3'>
                                        <div class="form-group" style="text-align:right">
                                            ...
                                            <input style="border-radius: 3px;text-align:left" type="text" value="<?= $data['bankInfo']['0']['b_account_opening_date']; ?>"
                                    ...
                                    <div class='col-md-4'>
                                        <div class="form-group" style="text-align:right">
                                            ...
                                            <select id="account_type" name="account_type" class="form-control select2Class"
                                                ...
                                                <option <?= "قرض الحسنه"==$data['bankInfo']['0']['b_account_type'] ?"selected='selected'":""; ?> value="قرض الحسنه" >قرض الحسنه</option>
                                                <option <?= "جاری"==$data['bankInfo']['0']['b_account_type'] ?"selected='selected'":""; ?> value="جاری" >جاری</option>
                                                <option <?= "سپرده کوتاه مدت"==$data['bankInfo']['0']['b_account_type'] ?"selected='selected'":""; ?> value="سپرده کوتاه مدت" >سپرده کوتاه مدت</option>
                                                <option <?= "سپرده بلند مدت"==$data['bankInfo']['0']['b_account_type'] ?"selected='selected'":""; ?> value="سپرده بلند مدت" >سپرده بلند مدت</option>
                                                <option <?= "سایر"==$data['bankInfo']['0']['b_account_type'] ?"selected='selected'":""; ?> value="سایر" >سایر</option>
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group" style="text-align:right">
                                            ...
                                            <select id="curreny" name="curreny" class="form-control select2Class"
                                                ...
                                                foreach ($data['currency'] as $currency) {
                                                    ?>
                                                    <option <?= $currency['c_id']==$data['bankInfo']['0']['b_currency'] ?"selected='selected'":""; ?> value="<?= $currency['c_id']; ?>">
                                    ...
                                    <div class='col-md-4'>
                                        <div class="form-group" style="text-align:right">
                                            ...
                                            <div class="input-group" id="current_balanceID">
                                                <input style="border-radius: 0 3px 3px 0;text-align:left;direction: ltr" type="text" value="<?= number_format($data['bankInfo']['0']['b_current_balance']); ?>"
                                    ...
                                    <div class='col-md-4'>
                                        <div class="form-group" style="text-align:right">
                                            ...
                                            <input style="border-radius: 3px;text-align:left;direction: ltr;" type="tel" value="<?= $data['bankInfo']['0']['b_account_number']; ?>"
                                    ...
                                    <div class='col-md-4'>
                                        <div class="form-group" style="text-align:right">
                                            ...
                                            <div class="input-group">
                                                <input style="border-radius: 0 3px 3px 0;text-align:left;direction: ltr;" type="tel" maxlength="24" class="form-control" id="no_sheba" value="<?= $data['bankInfo']['0']['b_sheba_number']; ?>" name="no_sheba">
                                    ...
                                    <div class='col-md-4'>
                                        <div class="form-group" style="text-align:right">
                                            ...
                                            <div class="input-group">
                                                <input style="border-radius: 0 3px 3px 0;text-align:left;direction: ltr;" type="tel" maxlength="19" onkeyup="setBankLogo();" value="<?= str_replace(" ","",$data['bankInfo']['0']['b_cart_number']); ?>"
                                    ...
                                    <div class='col-md-12'>
                                        <div class="form-group" style="text-align:right">
                                            ...
                                            <textarea style="border-radius: 3px;resize: vertical;text-align:right" class="form-control" rows="8" id="desc" name="desc"><?= $data['bankInfo']['0']['b_desc']; ?></textarea>
                                        </div>
                                    </div>
                                </div>
...
<script>
    $("#btnsubmit").on('click', function () {
        ...
        } else if (no_sheba != "-" && no_sheba != 0 && !IBAN.isValid("IR" + no_sheba)) {
            $.wnoty({type: 'warning', message: 'شماره شبا صحیح نمی باشد.'});
        } else if (no_card!="-" && no_card!=0 && !checkCartDigit(no_card.replace(/-/g, ""))) {
