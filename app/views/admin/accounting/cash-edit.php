...
<head>
    ...
    <title>ویرایش اطلاعات صندوق <?= $data['cashInfo']['0']['c_name']; ?> | <?= $data['getPublicInfo']['site']; ?></title>
    <!-- Favicon -->
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                <small>ویرایش اطلاعات صندوق <?= $data['cashInfo']['0']['c_name']; ?></small>
            </h1>
            <ol class="breadcrumb">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-warning">
                        <div class="box-header with-border">
                            <h3 class="box-title">ویرایش اطلاعات صندوق <?= $data['cashInfo']['0']['c_name']; ?></h3>
                        </div>
                        <!-- /.box-header -->
                        <div data-step="1" data-intro="برای ویرایش اطلاعات صندوق به راحتی می توانید بخش مورد نظر خود را ویرایش کنید."  class="box-body">
                            <div class="box-body">
                                <div class='row'>
                                    <div class='col-md-6'>
                                        <div class="form-group" style="text-align:right">
                                            <label style="width: 100%;" align="right" for="name">:نام صندوق</label>
                                            <input style="border-radius: 3px;text-align:right" type="text" value="<?= $data['cashInfo']['0']['c_name']; ?>"
                                    ...
                                    <div class='col-md-3'>
                                        <div class="form-group" style="text-align:right">
                                            ...
                                            <div class="input-group" id="current_balanceID">
                                                <input style="border-radius: 0 3px 3px 0;text-align:left;direction: ltr" type="text" value="<?= number_format($data['cashInfo']['0']['c_current_balance']); ?>"
                                        ...
                                        <div class="form-group" style="text-align:right">
                                            ...
                                            <select id="curreny" name="curreny" class="form-control select2Class"
                                                ...
                                                foreach ($data['currency'] as $currency) {
                                                    ?>
                                                    <option <?= $currency['c_id']==$data['cashInfo']['0']['c_currency'] ?"selected='selected'":""; ?> value="<?= $currency['c_id']; ?>">
                                    ...
                                    <div class='col-md-12'>
                                        <div class="form-group" style="text-align:right">
                                            ...
                                            <textarea style="border-radius: 3px;resize: vertical;text-align:right" class="form-control" rows="8" id="desc" name="desc"><?= $data['cashInfo']['0']['c_desc']; ?></textarea>
                                        </div>
                                    </div>
                                </div>
