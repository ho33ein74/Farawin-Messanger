...
<head>
    ...
    <title>ثبت هزینه جدید | <?= $data['getPublicInfo']['site']; ?></title>
    <!-- Favicon -->
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <?php if($data['publicData']['request']['cost_type']){  ?>
            <div class="col-lg-12 col-xs-12 mt-3">
                <div style="direction: rtl" class="alert alert-danger callout callout-danger alert-dismissible">
                    ...
                    برای استفاده از این بخش ابتدا از بخش دسته بندی هزینه ها قسمت افزودن دسته جدید، حداقل یک دسته بندی اضافه نمایید.
                </div>
            </div>
        <?php } ?>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-warning">
                        <div class="box-header with-border">
                            <h3 class="box-title">ثبت هزینه جدید</h3>
                        </div>
                        <!-- /.box-header -->
                                            ...
                                            <div class="form-group" style="text-align:right">
                                                ...
                                                <select id="costType" name="costType" class="form-control select2Class"
                                                    ...
                                                    foreach ($data['costType'] as $type) {
                                                        ?>
                                                        <option value="<?= $type['cost_category_vids_id']; ?>">
                                                            <?= $type['title']; ?>
                                                        </option>
                                                        <?php
                                                    }
           ...
           if (navigator.onLine) {
               ...
               $.ajax({
                   ...
                   success: function (data) {
                       ...
                       if (data.status == "ok") {
                           window.location.href = '<?= ADMIN_PATH; ?>/cost';
                       }
                   }
               });
           } else {
