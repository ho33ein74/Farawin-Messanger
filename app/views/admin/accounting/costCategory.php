...
<head>
    ...
    <title>لیست دسته بندی هزینه ها | <?= $data['getPublicInfo']['site']; ?></title>
    <!-- Favicon -->
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                <small>لیست دسته بندی هزینه ها</small>
            </h1>
            <ol class="breadcrumb">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-warning">
                        ...
                        <!-- /.box-header -->
                        <div data-step="1" data-intro="برای افزودن دسته بندی جدید برای هزینه ها می بایست اطلاعات خواسته شده را تکمیل نمایید."  class="box-body">
                            <div class="box-body">
                                <div class='row'>
                                    <div class='col-md-12'>
                ...
                <div class="col-md-8">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">مدیریت دسته بندی هزینه ها</h3>
                        </div>
                        <!-- /.box-header -->
                        <div data-step="1" data-intro="در این بخش لیست کامل دسته بندی هایی که برای هزینه ها ثبت کرده اید به شما نمایش داده می شود که به نکات زیر توجه نمایید:<br/><br/>1- برای گرفتن خروجی می توانید از دکمه های خروجی اکسل و یا خروجی csv بسته به نیاز استفاده نمایید.<br/><br/>2- برای پرینت اطلاعات می توانید از دکمه پرینت استفاده نمایید.<br/><br/>3- در صورتی که در هنگام گرفتن خروجی یا پرینت خواستید ستونی نمایش داده نشود می توانید از بخش فیلتر ستون ها، ستون مورد نظر خود را غیرفعال نمایید تا در خروجی مورد نظر نمایش داده نشود<br/><br/>4- به علت افزایش سرعت لود اطلاعات، اطلاعات به صورت محدود از دیتابیس خوانده می شود در صورتی که می خواهید لیست کامل اطلاعات را خروجی بگیرید کافیست از قسمت نمایش در پایین جدول گزینه همه را انتخاب و سپس اقدام به گرفتن خروجی نمایید.<br/><br/>5- برای جستجو و فیلتر کردن اطلاعات می توانید از فیلدهای موجود در زیر عنوان هر ستون استفاده نمایید و در صورت تمایل می توانید به صورت همزمان چند ستون را فیلتر نمایید تا اطلاعات مد نظر شما نمایش داده شود." class="box-body">
    ...
    $("#btnsubmit").on('click', function () {
        ...
        if (name == "") {
            ...
            if (navigator.onLine) {
                ...
                $.ajax({
                    url: "<?= ADMIN_PATH; ?>/addCostCategory",
                    data: formData,
                    type: "POST",
                    processData: false,
                    contentType: false,
    ...
    $(function () {
        ...
        var table = $('#example1').DataTable({
            ...
            "ajax": $.fn.dataTable.pipeline({
                url: '<?= ADMIN_PATH; ?>/getCostCategoryAjax',
                pages: 5
            })
        });
...
<script>
    ...
    $(document).on("click", "#delete-submit", function () {
        ...
        if (navigator.onLine) {
            ...
            $.ajax({
                url: "<?= ADMIN_PATH; ?>/delCostCategory",
                data: formData,
                type: "POST",
                processData: false,
                contentType: false,
