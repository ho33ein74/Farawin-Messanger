        ...
        var table = $('#example1').DataTable({
            ...
            "ajax": $.fn.dataTable.pipeline({
                ...
                this.api().columns(1).every(function () {
                    var column = this;
                    var select = $('<select><option value="0" disabled="" selected="" hidden="">انتخاب بخش مربوطه</option><option value="">همه موارد</option><option value="2">خدمات</option><option value="3">سایر</option></select>')
