...
<head>
    ...
    <title>پیام های پشتیبانی | <?= $data['getPublicInfo']['site']; ?></title>
    <!-- Favicon -->
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                <small>لیست پیام های پشتیبانی</small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="<?= URL; ?><?= ADMIN_PATH; ?>/dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
                <li><a href="<?= URL; ?><?= ADMIN_PATH; ?>/support"><i class="fa fa-support"></i> Support</a></li>
            </ol>
        </section>
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">پیام های پشتیبانی</h3>
                        </div>
                        <!-- /.box-header -->
                            ...
                            <div class="table-responsive direction">
                                <table id="example1" class="table table-bordered table-striped" style="width: 100%">
                                    ...
                                    <tr>
                                        ...
                                        <th class="priority-1" style="text-align:center">موضوع</th>
                                        <th class="priority-1" style="text-align:center;">نام و نام خانوادگی</th>
                                        <th class="priority-1" style="text-align:center;">ایمیل</th>
                                        <th class="priority-1" style="text-align:center;">شماره تماس</th>
                                        <th class="priority-1" style="text-align:center;">متن</th>
                                        <th class="priority-1" style="text-align:center;">تاریخ ثبت</th>
                                        <th class="priority-1" style="text-align:center;">وضعیت</th>
                                        <th class="priority-1" style="text-align:center;width: 80px">عملیات</th>
                                    </tr>
                                    </thead>
                                    <tfoot>
                                    <tr>
...
<script>
    $(function () {
        let status_state_inp, title_state_inp = null;
        ...
        <?php
            $contact_subject = '';
            foreach ($data['contactSubject'] as $subject) {
                $contact_subject .= '<option value="' . $subject['id'] . '">' . $subject['title'] . '</option>';
            }
        ?>
        ...
        var table = $('#example1').DataTable({
            ...
            "stateLoadParams": function(settings, data) {
                const  select_array = [0, "", 2, 3, 4, 5, 6, "", 8];
                for (i = 0; i < data.columns["length"]; i++) {
                    ...
                    if (col_search_val != "") {
                        if (select_array[i] !== "") {
                            ...
                            switch(i){
                                case 1:
                                    title_state_inp = col_search_val.replace("^", "").replace("$", "");
                                    break;
                                case 7:
            ...
            "ajax": $.fn.dataTable.pipeline({
                url: '<?= ADMIN_PATH; ?>/getSupportAjax',
                pages: 5
            }), initComplete: function () {
                this.api().columns(1).every(function () {
                    var column = this;
                    var select = $('<select><option value="0" disabled="" selected="" hidden="">انتخاب موضوع</option><option value="">همه موارد</option><?= $contact_subject; ?></select>')
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.status == "ok") {
                        ...
                        document.getElementById("btn-status-" + id).innerHTML = 'تایید شده';
                    }
                },
            });
        } else {
