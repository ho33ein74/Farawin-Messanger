...
<head>
    ...
    <title>مدیریت تصاویر بنرهای تبلیغاتی | <?= $data['getPublicInfo']['site']; ?></title>
    <!-- Favicon -->
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                <small>لیست تصاویر بنرهای تبلیغاتی</small>
            </h1>
            <ol class="breadcrumb">
                ...
                <li><a href="<?= URL; ?><?= ADMIN_PATH; ?>/banners"><i class="fa fa-images"></i> Banners</a></li>
                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-warning">
                        <div class="box-header with-border">
                            <h3 class="box-title">ثبت تصویر جدید</h3>
                                ...
                                <div class='row'>
                                    <div class='col-md-12'>
                                        <div class="form-group" style="text-align:right">
                                            <label style="width: 100%" align="right" for="description">:متن جایگزین </label>
                                    ...
                                    <div class='col-md-12'>
                                        <div class="form-group" style="text-align:right">
                                            <label style="width: 100%" align="right" for="link">:لینک </label>
                                            <input style="border-radius: 3px;text-align:right" type="text"
                                                   class="form-control" id="link" name="link" required>
                                        </div>
                                    </div>

                                    <div class='col-md-12'>
                                        <div class="form-group" style="text-align:right">
                                            <label style="width: 100%" align="right" for="cover">:تصویر</label>
        ...
        <div class="modal-dialog" style="width: 300px;">
            ...
            <div class="modal-content">
                <div class="modal-header" style="color: #fff;background: #2484c6;">
                    ...
                    <h4 class="modal-title">تغییر وضعیت تصویر</h4>
                </div>
                    ...
                    <div id="form-regular-delete" class="login-fold" style="display: inline;block">
                        <p class="email-wrap">
                            <label style="font-size: .9em;color: #777;display: inline-block;margin-top: 10px;font-weight: 700;">آیا
                                از تغییر وضعیت این تصویر اطمینان دارید؟</label>
                ...
                <div class="modal-footer"
                    ...
                    <span>در صورت فعال بودن، تصویر در لیست های مورد نیاز نمایش داده خواهد شد.</span>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" style="padding: 0 15px;text-align: right;text-align: right;">
                    <div id="form-regular-delete" class="login-fold" style="display: inline;block">
                        <p class="email-wrap">
                            <label style="font-size: .9em;color: #777;display: inline-block;margin-top: 10px;font-weight: 700;">آیا
                                از حذف این تصویر اطمینان دارید؟</label>
                ...
                <div class="modal-footer"
                     style="margin-top: 10px !important;font-size: .8em;background: #f8f8f8;padding: 15px;text-align: right;border-bottom: 1px solid #e5e5e5;">
                    <span>توجه کنید در صورت حذف تمامی  مطالب مربوط به این تصویر نیز حذف میگردد و امکان بازیابی نیز وجود ندارد.</span>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" style="padding: 0 15px;text-align: right;text-align: right;">
                    <div id="form-regular-delete" class="login-fold row" style="display: inline;block">
                        <div class="col-md-12">
                            <div class="form-group" style="text-align:right">
                                <label style="width: 100%;" align="right" for="descriptionEdit">متن جایگزین :</label>
                                <input style="border-radius: 3px;text-align:right" type="text" class="form-control" id="descriptionEdit" name="descriptionEdit" required="">
                            </div>
                        </div>

                        <div class="col-md-12">
                            <div class="form-group" style="text-align:right">
                                <label style="width: 100%;" align="right" for="coverEdit">تصویر :</label>
                        ...
                        <div class="col-md-12">
                            <div class="form-group" style="text-align:right">
                                ...
                                <input style="border-radius: 3px;text-align:right" type="text" class="form-control" id="linkEdit" name="linkEdit" required="">
                            </div>
                        </div>
...
<script>
    ...
    $('.image-upload-wrap-edit').bind('dragover', function() {
        $('.image-upload-wrap-edit').addClass('image-dropping');
    });
    ...
    $('.image-upload-wrap-edit').bind('dragleave', function() {
        $('.image-upload-wrap-edit').removeClass('image-dropping');
    });
</script>
    ...
    $(function () {
        ...
        var table = $('#example1').DataTable({
            ...
            "ajax": $.fn.dataTable.pipeline({
                url: "<?= ADMIN_PATH; ?>/getBannersImagesAjax?id=<?= $data['attrId'] ?>",
                pages: 5
...
<script>
    ...
    $(document).on("click", "#status-submit", function () {
        ...
        if (navigator.onLine) {
            ...
            $.ajax({
                url: "<?= ADMIN_PATH; ?>/statusBannersImages",
                data: formData,
                type: "POST",
                processData: false,
                contentType: false,
...
<script>
    $("#btnsubmit").on('click', function () {
        ...
        var coverBannersImages = document.getElementById("cover");
        var cover = coverBannersImages.files[0];

        if (description == "") {
            $.wnoty({type: 'warning', message: 'متن جایگزین تصویر را وارد کنید.'});
        } else {
            ...
            if (navigator.onLine) {
                ...
                $.ajax({
                    url: "<?= ADMIN_PATH; ?>/addBannersImages",
                    type: "POST",
                    data: formData,
                    processData: false,
                    contentType: false,
...
<script>
    $(document).on("click", "[id*=btn-edit-]", function () {
        ...
        if($(this).data('image') != "public/images/icons/") {
            $('.image-upload-wrap-edit').hide();
            $('.file-upload-image-edit').attr('src', $(this).data('image'));
    ...
    $(document).on("click", "#edit-submit", function () {
        ...
        var coverEditIcons = document.getElementById("coverEdit");
        var coverEdit = coverEditIcons.files[0];

        if (descriptionEdit == "") {
            $.wnoty({type: 'warning', message: 'متن جایگزین تصویر را وارد کنید.'});
        } else {
            $("#edit-submit").attr("disabled", "disabled");
            document.getElementById("edit-submit").value =("در حال ویرایش...");
            ...
            if (navigator.onLine) {
                ...
                formData.append("coverEdit", coverEdit);
                $.ajax({
                    url: "<?= ADMIN_PATH; ?>/editBannersImages",
                    type: "POST",
                    data: formData,
                    processData: false,
                    contentType: false,
                    success: function (data) {
                        ...
                        if (data.status == "ok") {
                            ...
                            $("#btn-edit-" + id).parent().prev().prev().prev().html(linkEdit);

                            $("#btn-edit-" + id).data('description', descriptionEdit);
                            $("#btn-edit-" + id).data('link', linkEdit);
                        }
                    }
                });
            } else {
...
<script>
    ...
    $(document).on("click", "#delete-submit", function () {
        ...
        if (navigator.onLine) {
            ...
            formData.append("id", id);
            $.ajax({
                url: "<?= ADMIN_PATH; ?>/delBannersImages",
                data: formData,
                type: "POST",
                processData: false,
                contentType: false,
