...
<head>
    ...
    <title>مدیریت فایل ها | <?= $data['getPublicInfo']['site']; ?></title>
    <!-- Favicon -->
    ...
    <div class="content-wrapper">
        ...
        <section class="content" style="min-height: unset;padding-bottom: 0">
            <div class="row">
                <!-- left column -->
                <div class="col-md-12">
                    <iframe style="width:100%;border: none;height: 100vh;" src="public/library/filemanager/tinyfilemanager.php" title="description"></iframe>
                </div>
                <!-- /.row -->
            </div>
            <!-- /.row -->
