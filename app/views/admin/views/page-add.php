...
<head>
    ...
    <title>افزودن برگه جدید | <?= $data['getPublicInfo']['site']; ?></title>
    <!-- Favicon -->
                                    ...
                                    <div data-intro="آدرس برگه می بایست به صورت یکتا باشد و قبلا ثبت نشده باشد که در صورت تکراری بودن به شما هشدار داده می شود." class='col-md-12'>
                                        <div class="form-group" style="text-align:right">
                                            ...
                                            <div class="input-group">
                                                <input style="direction: ltr;border-radius: 0 3px 3px 0;text-align:left" type="text" class="form-control" id="slug" name="slug" required="">
                ...
                <div class="col-md-3">
                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body text-center">
                            ...
                            <input id="address-val" type="hidden" value="0"/>
                    ...
                    <div data-intro="در این بخش عکس کاور برگه را می توانید انتخاب نمایید. تا حد امکان سعی کنید که حجم تصویر زیاد نباشد تا باعث کند شدن لود صفحه نگردد." class="box box-info">
                        ...
                        <div class="file-upload">
                            ...
                            <div class="file-upload-content">
                                <img style="width: 100%;" class="file-upload-image" alt="your image">
...
<script>
    $("#btnsubmit").on('click', function () {
        ...
        if (title == "") {
        ...
        } else if (slug == "view" || slug == "index") {
            $.wnoty({type: 'error', message: 'آدرس برگه نمی تواند ' + slug + ' باشد.'});
        } else if (desc == "") {
            ...
            if(address == 1) {
                ...
                $.wnoty({type: 'error', message: 'آدرس صفحه معتبر نمی باشد؛ آن را اصلاح و مجددا تلاش نمایید.'});
            }
        }
    })
    ;
