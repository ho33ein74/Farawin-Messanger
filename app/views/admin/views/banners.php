...
<head>
    ...
    <title>مدیریت بنرهای تبلیغاتی | <?= $data['getPublicInfo']['site']; ?></title>
    <!-- Favicon -->
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                <small>لیست بنرهای تبلیغاتی</small>
            </h1>
            <ol class="breadcrumb">
                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-warning">
                        <div class="box-header with-border">
                            <h3 class="box-title">ثبت بنر جدید</h3>
                                ...
                                <div class='row'>
                                    <div class='col-md-12'>
                                        <div class="form-group" style="text-align:right">
                                            <label style="width: 100%" align="right" for="title">:عنوان بنر </label>
                                    ...
                                    <div class='col-md-12'>
                                        <div class="form-group" style="text-align:right">
                                            ...
                                            <select style="width: 100%;" id="type" name="type" class="form-control" style="border-radius: 3px;width: 100%;direction: rtl">
                                                <option data-name="تکی" value="1">تکی</option>
                                                <option data-name="2 تایی" value="2">2 تایی</option>
                                                <option data-name="3 تایی" value="3">3 تایی</option>
                                                <option data-name="4 تایی" value="4">4 تایی</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="table-responsive direction">
                                <table id="example1" class="table table-bordered table-striped" style="width: 100%">
                                    ...
                                    <tr>
                                        ...
                                        <th class="priority-1" style="text-align:center">نوع بنر</th>
        ...
        <div class="modal-dialog" style="width: 300px;">
            ...
            <div class="modal-content">
                <div class="modal-header" style="color: #fff;background: #2484c6;">
                    ...
                    <h4 class="modal-title">تغییر وضعیت بنر </h4>
                </div>
                    ...
                    <div id="form-regular-delete" class="login-fold" style="display: inline;block">
                        <p class="email-wrap">
                            <label style="font-size: .9em;color: #777;display: inline-block;margin-top: 10px;font-weight: 700;">آیا
                                از تغییر وضعیت این بنر اطمینان دارید؟</label>
                ...
                <div class="modal-footer"
                    ...
                    <span>در صورت فعال بودن، بنر در لیست های مورد نیاز نمایش داده خواهد شد.</span>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" style="padding: 0 15px;text-align: right;text-align: right;">
                    <div id="form-regular-delete" class="login-fold" style="display: inline;block">
                        <p class="email-wrap">
                            <label style="font-size: .9em;color: #777;display: inline-block;margin-top: 10px;font-weight: 700;">آیا
                                از حذف این بنر اطمینان دارید؟</label>
                ...
                <div class="modal-footer"
                     style="margin-top: 10px !important;font-size: .8em;background: #f8f8f8;padding: 15px;text-align: right;border-bottom: 1px solid #e5e5e5;">
                    <span>توجه کنید در صورت حذف تمامی  مطالب مربوط به این بنر نیز حذف میگردد و امکان بازیابی نیز وجود ندارد.</span>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" style="padding: 0 15px;text-align: right;text-align: right;">
                    <div id="form-regular-delete" class="login-fold row" style="display: inline;block">
                        <div class="col-md-12">
                            <div class="form-group" style="text-align:right">
                                <label style="width: 100%;" align="right" for="titleEdit">عنوان بنر :</label>
                                <input style="border-radius: 3px;text-align:right" type="text" class="form-control" id="titleEdit" name="titleEdit" required="">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group" style="text-align:right">
                                <label style="width: 100%;" align="right" for="typeEdit">عنوان بنر :</label>
                                <select style="width: 100%;" id="typeEdit" name="typeEdit" class="form-control" style="border-radius: 3px;width: 100%;direction: rtl">
                                    <option data-name="تکی" value="1">تکی</option>
                                    <option data-name="2 تایی" value="2">2 تایی</option>
                                    <option data-name="3 تایی" value="3">3 تایی</option>
                                    <option data-name="4 تایی" value="4">4 تایی</option>
    ...
    $(function () {
        ...
        var table = $('#example1').DataTable({
            ...
            "ajax": $.fn.dataTable.pipeline({
                url: "<?= ADMIN_PATH; ?>/getBannersAjax",
                pages: 5
            }), initComplete: function () {
                this.api().columns(2).every(function () {
                    var column = this;
                    var select = $('<select><option value="0" disabled="" selected="" hidden="">انتخاب نوع بنر</option><option value="">همه موارد</option><option value="1">تکی</option><option value="2">2 تایی</option><option value="3">3 تایی</option><option value="4">4 تایی</option></select>')
...
<script>
    $("#btnsubmit").on('click', function () {
        ...
        if (title == "") {
            $.wnoty({type: 'warning', message: 'عنوان بنر را وارد کنید.'});
        } else if (type == "") {
            $.wnoty({type: 'warning', message: 'دسته بندی را انتخاب کنید.'});
        } else {
