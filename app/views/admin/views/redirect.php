...
<head>
    ...
    <title>مدیریت ریدایرکت صفحات | <?= $data['getPublicInfo']['site']; ?></title>
    <!-- Favicon -->
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                <small>لیست ریدایرکت صفحات</small>
            </h1>
            <ol class="breadcrumb">
                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-warning">
                        <div class="box-header with-border">
                            <h3 class="box-title">ثبت لینک جدید</h3>
                                ...
                                <div class='row'>
                                    <div class='col-md-12'>
                                        <div class="form-group" style="text-align:right">
                                            <label style="width: 100%" align="right" for="old_url">:لینک قدیم</label>
                                            <input style="border-radius: 3px;text-align:left;direction: ltr" type="link" class="form-control" id="old_url" name="old_url" required>
                                        </div>
                                    </div>
                                    <div class='col-md-12'>
                                        <div class="form-group" style="text-align:right">
                                            <label style="width: 100%" align="right" for="new_url">:لینک جدید</label>
                                            <input style="border-radius: 3px;text-align:left;direction: ltr" type="link" class="form-control" id="new_url" name="new_url" required>
                                        </div>
                                    </div>

                                    <div class='col-md-12'>
                                        <div class="form-group" style="text-align:right">
                                            <label for="type">:نوع انتقال</label>
                                            <select style="width: 100%;" id="type" name="type" class="form-control" style="border-radius: 3px;width: 100%;direction: ltr;text-align: left">
                                                <option data-name="301 - Moved Permanently" value="301">301 - Moved Permanently</option>
                                                <option data-name="302 - Found" value="302">302 - Found</option>
                                                <option data-name="303 - See Other" value="303">303 - See Other</option>
                                                <option data-name="307 - Temporary Redirect (HTTP/1.1)" value="307">307 - Temporary Redirect (HTTP/1.1)</option>
                                                <option data-name="404 - Not Found" value="404">404 - Not Found</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-md-8">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">مدیریت ریدایرکت صفحات</h3>
                        </div>
                        <!-- /.box-header -->
                        <div data-step="1" data-intro="در این بخش لیست لینک هایی که به سیستم اضافه کرده اید تا ریدایرکت شوند به شما نمایش داده می شود که به نکات زیر توجه نمایید:<br/><br/>1- برای گرفتن خروجی می توانید از دکمه های خروجی اکسل و یا خروجی csv بسته به نیاز استفاده نمایید.<br/><br/>2- برای پرینت اطلاعات می توانید از دکمه پرینت استفاده نمایید.<br/><br/>3- در صورتی که در هنگام گرفتن خروجی یا پرینت خواستید ستونی نمایش داده نشود می توانید از بخش فیلتر ستون ها، ستون مورد نظر خود را غیرفعال نمایید تا در خروجی مورد نظر نمایش داده نشود<br/><br/>4- به علت افزایش سرعت لود اطلاعات، اطلاعات به صورت محدود از دیتابیس خوانده می شود در صورتی که می خواهید لیست کامل اطلاعات را خروجی بگیرید کافیست از قسمت نمایش در پایین جدول گزینه همه را انتخاب و سپس اقدام به گرفتن خروجی نمایید.<br/><br/>5- برای جستجو و فیلتر کردن اطلاعات می توانید از فیلدهای موجود در زیر عنوان هر ستون استفاده نمایید و در صورت تمایل می توانید به صورت همزمان چند ستون را فیلتر نمایید تا اطلاعات مد نظر شما نمایش داده شود." class="box-body">
                            <div class="table-responsive direction">
                                <table id="example1" class="table table-bordered table-striped" style="width: 100%">
                                    <thead>
                                    <tr>
                                        <th class="priority-1" style="text-align:center;width: 50px">ردیف</th>
                                        <th class="priority-1" style="text-align:center">لینک قدیم</th>
                                        <th class="priority-1" style="text-align:center">لینک جدید</th>
                                        <th class="priority-1" style="text-align:center">نوع انتقال</th>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" style="padding: 0 15px;text-align: right;text-align: right;">
                    <div id="form-regular-delete" class="login-fold" style="display: inline;block">
                        <p class="email-wrap">
                            <label style="font-size: .9em;color: #777;display: inline-block;margin-top: 10px;font-weight: 700;">آیا از حذف این لینک اطمینان دارید؟</label>
                ...
                <div class="modal-body" style="padding: 0 15px;text-align: right;text-align: right;">
                    <div id="form-regular-delete" class="login-fold row" style="display: inline;block">
                        <div class="col-md-12">
                            <div class="form-group" style="text-align:right">
                                <div class="form-group" style="text-align:right">
                                    <label style="width: 100%" align="right" for="old_urlEdit">لینک قدیم:</label>
                                    <input style="border-radius: 3px;text-align:left;direction: ltr" type="link" class="form-control" id="old_urlEdit" name="old_urlEdit" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group" style="text-align:right">
                                <div class="form-group" style="text-align:right">
                                    <label style="width: 100%" align="right" for="new_urlEdit">لینک جدید:</label>
                                    <input style="border-radius: 3px;text-align:left;direction: ltr" type="link" class="form-control" id="new_urlEdit" name="new_urlEdit" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group" style="text-align:right">
                                <label style="width: 100%;" align="right" for="typeEdit">نوع انتقال:</label>
                                <select style="width: 100%;" id="typeEdit" name="typeEdit" class="form-control" style="border-radius: 3px;width: 100%;direction: ltr">
                                    <option data-name="301 - Moved Permanently" value="301">301 - Moved Permanently</option>
                                    <option data-name="302 - Found" value="302">302 - Found</option>
                                    <option data-name="303 - See Other" value="303">303 - See Other</option>
                                    <option data-name="307 - Temporary Redirect (HTTP/1.1)" value="307">307 - Temporary Redirect (HTTP/1.1)</option>
    ...
    $(function () {
        ...
        var table = $('#example1').DataTable({
            ...
            "ajax": $.fn.dataTable.pipeline({
                url: "<?= ADMIN_PATH; ?>/getRedirectLinkAjax",
                pages: 5
            }), initComplete: function () {
                this.api().columns(3).every(function () {
                    var column = this;
                    var select = $('<select><option value="0" disabled="" selected="" hidden="">انتخاب نوع انتقال</option><option value="">همه موارد</option><option value="301">301 - Moved Permanently</option><option value="302">302 - Found</option><option value="303">303 - See Other</option><option value="307">307 - Temporary Redirect (HTTP/1.1)</option><option value="404">404 - Not Found</option></select>')
...
<script>
    $("#btnsubmit").on('click', function () {
        ...
        if (new_url == "") {
            $.wnoty({type: 'warning', message: 'لینک جدید را وارد کنید.'});
        } else if (old_url == "") {
            $.wnoty({type: 'warning', message: 'لینک قدیم را وارد کنید.'});
        } else {
            ...
            if (navigator.onLine) {
                ...
                formData.append("new_url", new_url);
                formData.append("old_url", old_url);
                formData.append("type", type);
                $.ajax({
                    url: "<?= ADMIN_PATH; ?>/addRedirect",
                    type: "POST",
                    data: formData,
                    processData: false,
                    contentType: false,
...
<script>
    $(document).on("click", "[id*=btn-edit-]", function () {
        ...
        $("#old_urlEdit").val(info.old_url);
        $("#new_urlEdit").val(info.new_url);
        $("#typeEdit").val(info.type).change();
    });
    ...
    $(document).on("click", "#edit-submit", function () {
        ...
        var old_urlEdit = document.getElementById('old_urlEdit').value;
        var new_urlEdit = document.getElementById('new_urlEdit').value;
        ...
        if (old_urlEdit == "") {
            ...
            document.getElementById("edit-submit").value = ("در حال ثبت...");

            if (navigator.onLine) {
                var formData = new FormData();
                formData.append("id", id);
                formData.append("new_urlEdit", new_urlEdit);
                formData.append("old_urlEdit", old_urlEdit);
                formData.append("typeEdit", typeEdit);
                $.ajax({
                    url: "<?= ADMIN_PATH; ?>/editRedirect",
                    type: "POST",
                    data: formData,
                    processData: false,
                    contentType: false,
                    success: function (data) {
                        ...
                        if (data.status == "ok") {
                            $("#btn-edit-" + id).parent().prev().prev().prev().html(old_urlEdit);
                            $("#btn-edit-" + id).parent().prev().prev().html(new_urlEdit);
                            $("#btn-edit-" + id).parent().prev().html($("#typeEdit").find(':selected').val());
            ...
            document.getElementById("edit-submit").value =("ویرایش");
        }
    });
</script>
