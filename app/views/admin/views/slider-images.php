...
<head>
    ...
    <title>مدیریت تصاویر اسلایدر | <?= $data['getPublicInfo']['site']; ?></title>
    <!-- Favicon -->
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                <small>لیست تصاویر اسلایدر</small>
            </h1>
            <ol class="breadcrumb">
                ...
                <li><a href="<?= URL; ?><?= ADMIN_PATH; ?>/slider"><i class="fa fa-images"></i> Slider</a></li>
        ...
        <div class="modal-dialog" style="width: 300px;">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer"
                    ...
                    <span>در صورت فعال بودن، تصویر در اسلایدر نمایش داده خواهد شد.</span>
                </div>
            </div>
        </div>
    </div>
    ...
    $(function () {
        ...
        var table = $('#example1').DataTable({
            ...
            "ajax": $.fn.dataTable.pipeline({
                url: "<?= ADMIN_PATH; ?>/getSliderImagesAjax?id=<?= $data['attrId'] ?>",
                pages: 5
...
<script>
    ...
    $(document).on("click", "#status-submit", function () {
        ...
        if (navigator.onLine) {
            ...
            $.ajax({
                url: "<?= ADMIN_PATH; ?>/statusSliderImages",
                data: formData,
                type: "POST",
                processData: false,
                contentType: false,
...
<script>
    $("#btnsubmit").on('click', function () {
        ...
        var link = toEnglishNumber(document.getElementById("link").value);
        ...
        if (title == "") {
            ...
            $.wnoty({type: 'warning', message: 'لینک اسلایدر را وارد کنید.'});
        } else {
            ...
            if (navigator.onLine) {
                ...
                $.ajax({
                    url: "<?= ADMIN_PATH; ?>/addSliderImages",
                    type: "POST",
                    data: formData,
                    processData: false,
                    contentType: false,
...
<script>
    $("#link,#linkEdit").keypress(function(event){
        var ew = event.which;
...
<script>
    $(document).on("click", "[id*=btn-edit-]", function () {
        ...
        if($(this).data('image') != "public/images/slider/") {
    ...
    $(document).on("click", "#edit-submit", function () {
        ...
        var coverEditSlider = document.getElementById("coverEdit");
        var coverEdit = coverEditSlider.files[0];
        ...
        if (titleEdit == "") {
            ...
            if (navigator.onLine) {
                ...
                $.ajax({
                    url: "<?= ADMIN_PATH; ?>/editSliderImages",
                    type: "POST",
                    data: formData,
                    processData: false,
                    contentType: false,
...
<script>
    ...
    $(document).on("click", "#delete-submit", function () {
        ...
        if (navigator.onLine) {
            ...
            formData.append("id", id);
            $.ajax({
                url: "<?= ADMIN_PATH; ?>/delSliderImages",
                data: formData,
                type: "POST",
                processData: false,
                contentType: false,
