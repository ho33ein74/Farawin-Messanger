...
<head>
    ...
    <title>لیست انبارها | <?= $data['getPublicInfo']['site']; ?></title>
    <!-- Favicon -->
                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-warning">
                        <div class="box-header with-border">
                            <h3 class="box-title">ثبت انبار جدید</h3>
                        </div>
                        <!-- /.box-header -->
                        <div data-step="1" data-intro="برای افزودن انبار جدید می بایست اطلاعات خواسته شده را تکمیل نمایید." class="box-body">
                            <div class="box-body">
                                <div class='row'>
                                    <div class='col-md-12'>
                                        <div class="form-group" style="text-align:right">
                                            <label style="width: 100%;" align="right" for="name">:عنوان انبار</label>
                                    ...
                                    <div class='col-md-12'>
                                        <div class="form-group" style="text-align:right">
                                            <label style="width: 100%;" align="right" for="storekeeper">:انباردار</label>
                                            <input style="border-radius: 3px;text-align:right" type="text"
                                                   class="form-control" id="storekeeper" name="storekeeper" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class='col-md-12'>
                                        <div class="form-group" style="text-align:right">
                                            ...
                                            <select id="branch" name="branch" class="form-control select2Class" style="border-radius: 3px;width: 100%;" required>
                                                <?php foreach ($data['branchesInfo'] as $type) { ?>
                                                    <option  value="<?= $type['branch_vids_id']; ?>">
                                                        <?= $type['b_name']; ?>
                                                    </option>
                                                    <?php } ?>
                                            </select>
                ...
                <div class="col-md-8">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">مدیریت انبارها</h3>
                        </div>
                        <!-- /.box-header -->
                        <div data-step="1" data-intro="در این بخش لیست کامل انبارها به شما نمایش داده می شود که به نکات زیر توجه نمایید:<br/><br/>1- برای گرفتن خروجی می توانید از دکمه های خروجی اکسل و یا خروجی csv بسته به نیاز استفاده نمایید.<br/><br/>2- برای پرینت اطلاعات می توانید از دکمه پرینت استفاده نمایید.<br/><br/>3- در صورتی که در هنگام گرفتن خروجی یا پرینت خواستید ستونی نمایش داده نشود می توانید از بخش فیلتر ستون ها، ستون مورد نظر خود را غیرفعال نمایید تا در خروجی مورد نظر نمایش داده نشود<br/><br/>4- به علت افزایش سرعت لود اطلاعات، اطلاعات به صورت محدود از دیتابیس خوانده می شود در صورتی که می خواهید لیست کامل اطلاعات را خروجی بگیرید کافیست از قسمت نمایش در پایین جدول گزینه همه را انتخاب و سپس اقدام به گرفتن خروجی نمایید.<br/><br/>5- برای جستجو و فیلتر کردن اطلاعات می توانید از فیلدهای موجود در زیر عنوان هر ستون استفاده نمایید و در صورت تمایل می توانید به صورت همزمان چند ستون را فیلتر نمایید تا اطلاعات مد نظر شما نمایش داده شود." class="box-body">
                            <div class="table-responsive direction">
                                <table id="example1" class="table table-bordered table-striped" style="width: 100%">
                                    <thead>
                                    <tr>
                                        <th class="priority-1" style="text-align:center;width: 30px">ردیف</th>
                                        <th class="priority-1" style="text-align:center">نام انبار</th>
                                        <th class="priority-1" style="text-align:center">شعبه</th>
                                        <th class="priority-1" style="text-align:center">انباردار</th>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" style="padding: 0 15px;text-align: right;text-align: right;">
                    <div id="form-regular-delete" class="login-fold row" style="display: inline;block">
                        <div class="col-md-12">
                            <div class="form-group" style="text-align:right">
                                <label style="width: 100%;" align="right" for="nameEdit">عنوان انبار :</label>
                        ...
                        <div class='col-md-12'>
                            <div class="form-group" style="text-align:right">
                                <label style="width: 100%;" align="right" for="branchEdit">شعبه :</label>
                                <select id="branchEdit" name="branchEdit" class="form-control select2Class" style="border-radius: 3px;width: 100%;" required>
                                    <?php foreach ($data['branchesInfo'] as $type) { ?>
                                        <option  value="<?= $type['branch_vids_id']; ?>">
                                            <?= $type['b_name']; ?>
                                        </option>
                        ...
                        <div class='col-md-12'>
                            <div class="form-group" style="text-align:right">
                                <label style="width: 100%;" align="right" for="storekeeperEdit">انباردار :</label>
                                <input style="border-radius: 3px;text-align:right" type="text"
                                       class="form-control" id="storekeeperEdit" name="storekeeperEdit" required>
                            </div>
                        </div>
    ...
    <div dir="rtl" class="modal fade" id="status-Modal" role="dialog">
        <div class="modal-dialog" style="width: 300px;">
            ...
            <div class="modal-content">
                <div class="modal-header" style="color: #fff;background: #2484c6;">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    <h4 class="modal-title">تغییر وضعیت انبار</h4>
                </div>
                <div class="modal-body" style="padding: 0 15px;text-align: right;text-align: right;">
                    <div id="form-regular-delete" class="login-fold" style="display: inline;block">
                        <p class="email-wrap">
                            <label style="font-size: .9em;color: #777;display: inline-block;margin-top: 10px;font-weight: 700;">آیا
                                از تغییر وضعیت این انبار اطمینان دارید؟</label>
                ...
                <div class="modal-footer"
                    ...
                    <span>در صورت فعال بودن، انبار در لیست های مورد نیاز نمایش داده خواهد شد.</span>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" style="padding: 0 15px;text-align: right;text-align: right;">
                    <div id="form-regular-delete" class="login-fold" style="display: inline;block">
                        <p class="email-wrap">
                            <label style="font-size: .9em;color: #777;display: inline-block;margin-top: 10px;font-weight: 700;">آیا
                                از حذف این انبار اطمینان دارید؟</label>
                ...
                <div class="modal-footer"
                     style="margin-top: 10px !important;font-size: .8em;background: #f8f8f8;padding: 15px;text-align: right;border-bottom: 1px solid #e5e5e5;">
                    <span>توجه کنید در صورت حذف تمامی اطلاعات مربوط به این انبار نیز حذف میگردد و امکان بازیابی نیز وجود ندارد.</span>
                </div>
            </div>
        </div>
    </div>
...
<script>
    $("#btnsubmit").on('click', function () {
        ...
        var storekeeper = document.getElementById("storekeeper").value;
        var branch = document.getElementById("branch").value;

        if (name == "") {
            $.wnoty({type: 'warning', message: 'عنوان انبار را وارد کنید.'});
        } else {
            if (navigator.onLine) {
                var formData = new FormData();
                formData.append("name", name);
                formData.append("storekeeper", storekeeper);
                formData.append("branch", branch);
                $.ajax({
                    url: "<?= ADMIN_PATH; ?>/addStoreroom",
                    data: formData,
                    type: "POST",
                    processData: false,
                    contentType: false,
...
<script>
    $(function () {
        let status_state_inp, branch_state_inp = null;
        ...
        foreach ($data['branchesInfo'] as $branch) {
        ...
        var table = $('#example1').DataTable({
            ...
            "ajax": $.fn.dataTable.pipeline({
                url: '<?= ADMIN_PATH; ?>/getStoreroomListAjax',
                pages: 5
            }), initComplete: function () {
                this.api().columns(2).every(function () {
                    var column = this;
                    var select = $('<select><option value="0" disabled="" selected="" hidden="">انتخاب شعبه</option><?= $branchData; ?></select>')
...
<script>
    $(document).on("click", "[id*=btn-edit-]", function () {
        ...
        $("#storekeeperEdit").val($(this).data('storekeeper'));
        $("#branchEdit").val($(this).data('branch')).change();
    });
    ...
    $(document).on("click", "#edit-submit", function () {
        ...
        var storekeeperEdit = document.getElementById('storekeeperEdit').value;
        var branchEdit = document.getElementById('branchEdit').value;

        if (navigator.onLine) {
            var formData = new FormData();
            formData.append("id", id);
            formData.append("nameEdit", nameEdit);
            formData.append("storekeeperEdit", storekeeperEdit);
            formData.append("branchEdit", branchEdit);
            $.ajax({
                url: "<?= ADMIN_PATH; ?>/editStoreroom",
                data: formData,
                type: "POST",
                processData: false,
                contentType: false,
                success: function (data) {
                    ...
                    if (data.status == "ok") {
                        $("#btn-edit-"+id).parent().prev().prev().prev().prev().html(nameEdit);
                        $("#btn-edit-"+id).parent().prev().prev().prev().html($('#branchEdit option:selected').text());
                        $("#btn-edit-"+id).parent().prev().prev().html(storekeeperEdit);

                        $("#btn-edit-"+id).data('name', nameEdit);
                        $("#btn-edit-"+id).data('storekeeper', storekeeperEdit);
                        $("#btn-edit-"+id).data('branch', branchEdit);
                    }
                },
            });
        } else {
...
<script>
    ...
    $(document).on("click", "#status-submit", function () {
        ...
        if (navigator.onLine) {
            ...
            formData.append("id", id);
            $.ajax({
                url: "<?= ADMIN_PATH; ?>/statusStoreroomList",
                data: formData,
                type: "POST",
                processData: false,
                contentType: false,
...
<script>
    ...
    $(document).on("click", "#delete-submit", function () {
        ...
        if (navigator.onLine) {
            ...
            formData.append("id", id);
            $.ajax({
                url: "<?= ADMIN_PATH; ?>/delStoreroomList",
                data: formData,
                type: "POST",
                processData: false,
                contentType: false,
