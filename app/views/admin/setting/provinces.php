...
<head>
    ...
    <title>مدیریت استان ها | <?= $data['getPublicInfo']['site']; ?></title>
    <!-- Favicon -->
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="box box-warning">
                            <div class="box-header with-border">
                                <h3 class="box-title">ثبت استان جدید</h3>
                                    ...
                                    <div class='row'>
                                        <div class='col-md-12'>
                                            <div class="form-group" style="text-align:right">
                                                <label style="width: 100%" align="right" for="title">:عنوان استان</label>
                    ...
                    <div class="col-md-8">
                        <div class="box">
                            <div class="box-header">
                                <h3 class="box-title">مدیریت استان</h3>
                            </div>
                            <!-- /.box-header -->
