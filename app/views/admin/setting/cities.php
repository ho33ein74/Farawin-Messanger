...
<head>
    ...
    <title>مدیریت شهرها | <?= $data['getPublicInfo']['site']; ?></title>
    <!-- Favicon -->
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="box box-warning">
                            <div class="box-header with-border">
                                <h3 class="box-title">ثبت شهر جدید</h3>
                                    ...
                                    <div class='row'>
                                        <div class='col-md-12'>
                                            <div class="form-group" style="text-align:right">
                                                ...
                                                <select id="provinceId" name="provinceId" class="form-control select2Class"
                                        ...
                                        <div class='col-md-12'>
                                            <div class="form-group" style="text-align:right">
                                                <label style="width: 100%" align="right" for="title">:عنوان شهر</label>
                    ...
                    <div class="col-md-8">
                        <div class="box">
                            <div class="box-header">
                                <h3 class="box-title">مدیریت شهر</h3>
                            </div>
                            <!-- /.box-header -->
                                ...
                                <div class="table-responsive direction">
                                    <table id="example1" class="table table-bordered table-striped" style="width: 100%">
                                        ...
                                        <tr>
                                            ...
                                            <th class="priority-1" style="text-align:center">استان</th>
        ...
        <div class="modal-dialog" style="width: 300px;">
            ...
            <div class="modal-content">
                <div class="modal-header" style="color: #fff;background: #2484c6;">
                    ...
                    <h4 class="modal-title">تغییر وضعیت شهر</h4>
                </div>
                    ...
                    <div id="form-regular-delete" class="login-fold" style="display: inline;block">
                        <p class="email-wrap">
                            <label style="font-size: .9em;color: #777;display: inline-block;margin-top: 10px;font-weight: 700;">آیا
                                از تغییر وضعیت این شهر اطمینان دارید؟</label>
                ...
                <div class="modal-footer"
                    ...
                    <span>در صورت فعال بودن، شهر در لیست های مورد نیاز نمایش داده خواهد شد.</span>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" style="padding: 0 15px;text-align: right;text-align: right;">
                    <div id="form-regular-delete" class="login-fold" style="display: inline;block">
                        <p class="email-wrap">
                            <label style="font-size: .9em;color: #777;display: inline-block;margin-top: 10px;font-weight: 700;">آیا
                                از حذف این شهر اطمینان دارید؟</label>
                ...
                <div class="modal-footer"
                     style="margin-top: 10px !important;font-size: .8em;background: #f8f8f8;padding: 15px;text-align: right;border-bottom: 1px solid #e5e5e5;">
                    <span>توجه کنید در صورت حذف تمامی مطالب مربوط به این شهر نیز حذف میگردد و امکان بازیابی نیز وجود ندارد.</span>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" style="padding: 0 15px;text-align: right;text-align: right;">
                    <div id="form-regular-delete" class="login-fold row" style="display: inline;block">
                        <div class='col-md-12'>
                            <div class="form-group" style="text-align:right">
                                ...
                                <select id="provinceIdEdit" name="provinceIdEdit" class="form-control select2Class" style="border-radius: 3px;width: 100%;direction: rtl" required>
                                    <?php foreach ($data['provinces'] as $province) { ?>
                                        <option data-name="<?= $province['pro_name']; ?>" value="<?= $province['pro_id']; ?>"><?= $province['pro_name']; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group" style="text-align:right">
                                <label style="width: 100%;" align="right" for="titleEdit">عنوان شهر:</label>
...
<script>
    $(function () {
        let status_state_inp, provinces_state_inp = null;
        ...
        var table = $('#example1').DataTable({
                ...
                for (i = 0; i < data.columns["length"]; i++) {
                    ...
                    if (col_search_val != "") {
                        if (select_array[i] !== "") {
                            ...
                            switch(i){
                                case 2:
                                    provinces_state_inp = col_search_val.replace("^", "").replace("$", "");
                                    break;
                                case 3:
            ...
            "ajax": $.fn.dataTable.pipeline({
                url: "<?= ADMIN_PATH; ?>/getCitiesAjax",
                pages: 5
            }), initComplete: function () {
                this.api().columns(2).every(function () {
                    var column = this;
                    var select = $('<select><option value="0" disabled="" selected="" hidden="">انتخاب استان</option><?= $provinces; ?></select>')
                    ...
                    $(select).children().each(function(d, j) {
                        if(j.value == provinces_state_inp){
...
<script>
    $("#btnsubmit").on('click', function () {
        ...
        if (title == "") {
            $.wnoty({type: 'warning', message: 'عنوان شهر را وارد کنید.'});
        } else {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.status == "ok") {
                        ...
                        $("#btn-edit-"+id).parent().prev().prev().html($("#provinceIdEdit").find(':selected').data('name'));
