    ...
    <main class="pt-20 ">
        ...
        <section class="mt-10 mb-10">
            <div class="container">
                ...
                <div class="grid lg:grid-cols-<?= $num_col ?> md:grid-cols-<?= $num_col ?> sm:grid-cols-<?= $num_col ?> gap-10">

                    <div class="about_us_mey_team flex flex-col items-center <?= $num_col == 2 ? "border-2":"" ?> transition duration-200 hover:shadow-sm border-blue-700 border-opacity-10 rounded-xl">
        ...
        <?php if($data['getPublicInfo']['location']!=""){ ?>
