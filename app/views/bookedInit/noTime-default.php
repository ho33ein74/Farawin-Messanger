                ...
                <div class="col-span-12 flex flex-col items-center mt-9">
                    ...
                    <div class="text-center md:bottom-16 -bottom-28">
                        <div class="mb-5">
                            ...
                            <p class="sm:text-22 text-sm text-gray-880 font-medium dark:text-white mt-2">تاریخ و یا ساعت انتخابی توسط شخص دیگری رزرو و یا منقضی شده است و متاسفانه امکان رزرو توسط شما وجود ندارد.</p>
                            <p class="sm:text-22 text-sm text-gray-880 font-medium dark:text-white mt-2">می توانید زمان دیگری انتخاب نمایید.</p>
                        </div>
                        <div class="">
                            <a class="text-blue-700 font-bold sm:text-lg text-xs mb-8 dark:text-blue-950" href="services">مشاهده لیست خدمات
