    ...
    <section class="xl:mt-11 lg:mt-11 mt-14">
        <div class="flex items-center justify-between sm:flex-row flex-col mb-20">
            <div class="flex items-center self-start sm:mb-0 mb-3">
                ...
                <h3 class="text-biscay-700 dark:text-white font-extrabold sm:text-4xl text-2xl"><?= $value[$file]['title'] ?></h3>
            </div>

            <div class="self-end">
                <a href="<?= $value[$file]['link'] ?>" class="flex items-center transform group">
                    <span class="text-dark-550 dark:group-hover:text-gray-20 dark:text-white font-normal text-22 ml-2 transition duration-200 group-hover:text-dark-700"><?= $value[$file]['link_title'] ?></span>
