<section class="lg:mt-16 mt-16 mb-16">
    <div class="flex xl:flex-row flex-col sm:mx-10 relative items-center justify-end xl:py-12 pb-12 pt-24 sm:px-16 px-9 bg-gradient-to-r from-purple-500 via-pink-500 to-orange-500 rounded-3xl">
        <img class="absolute xl:right-0  xl:scale-100 scale-75 right-1/2 transform xl:translate-x-0 translate-x-1/2  xl:-top-20  sm:-top-28 -top-24"
             src="public/images/index_instagram_phone.png" alt="<?= $value[$file]['link_title'] ?>"/>
        <h6 class="xl:ml-10 md:text-2xl text-lg text-white font-extrabold xl:mb-0 mb-5 xl:mt-0 sm:mt-8 md:text-right text-center">
            <?= $value[$file]['description'] ?>
        </h6>
        <a class=" px-5 py-3 flex items-center xl:text-15 sm:text-xs text-10 bg-white rounded text-purple-600 font-semibold transition duration-200 hover:text-white hover:bg-purple-600 border hover:border-1 border-white whitespace-nowrap"  href="<?= $value[$file]['link'] ?>">
            <?= $value[$file]['link_title'] ?>
            <svg width="16" height="11" viewBox="0 0 16 11" fill="none" class="mr-2" xmlns="http://www.w3.org/2000/svg">
                <path fill="currentColor" opacity="0.4" d="M10.8229 4.15815L13.8465 3.89075C14.525 3.89075 15.0752 4.44626 15.0752 5.13142C15.0752 5.81658 14.525 6.37209 13.8465 6.37209L10.8229 6.10469C10.2905 6.10469 9.85898 5.66892 9.85898 5.13142C9.85898 4.59301 10.2905 4.15815 10.8229 4.15815"/>
