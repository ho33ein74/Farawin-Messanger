        ...
        <div>
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <button data-id="<?= $news['n_id']; ?>" data-type="blog" data-part="blog" data-view="text" class="flex group add-like <?= $data['userId']!=FALSE ? "":" login_req";  ?> items-center px-1 h-5 ml-2 text-xs text-red-450 bg-red-700 dark:text-red-650 dark:hover:text-white dark:hover:bg-red-650 bg-opacity-10 rounded transition duration-200 hover:bg-opacity-100 hover:text-white">
                    ...
                    <button data-id="<?= $news['n_id']; ?>" data-type="blog" class="group flex items-center px-1 dark:hover:bg-blue-970 dark:hover:text-blue-700 dark:bg-blue-700 dark:text-blue-970 dark:bg-opacity-10 bg-blue-700 bg-opacity-10 h-5 rounded transition duration-200 hover:bg-opacity-100 add-bookmark <?= $news['bookmarked']!=NULL ? "text-blue-700":"text-gray-300";  ?> <?= $data['userId']!=FALSE ? "":" login_req";  ?>">
                ...
                <div class="flex items-center font-medium text-xs dark:text-gray-980 text-gray-400">
                    ...
                    زمان تقریبی مطالعه: <?= Model::get_read_time(htmlspecialchars_decode($news['description'])) ?> دقیقه
                </div>
            </div>
        </div>
    </div>
