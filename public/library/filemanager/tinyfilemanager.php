...
$CONFIG = '{"lang":"Fa","error_reporting":false,"show_hidden":false,"hide_Cols":true,"calc_folder":false,"theme":"light"}';
...
$auth_users = array(
    'admin' => password_hash('admin@123', PASSWORD_DEFAULT), //admin@123
    'admin' => password_hash('12345', PASSWORD_DEFAULT), //12345
);
...
function fm_show_nav_path($path)
{
    ...
    <nav class="navbar navbar-expand-lg <?php echo $getTheme; ?> mb-4 main-nav <?php echo $isStickyNavBar ?>">
        <a style="display: none" class="navbar-brand" href=""> <?php echo lng('AppTitle') ?> </a>
