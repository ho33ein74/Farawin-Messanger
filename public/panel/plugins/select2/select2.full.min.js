        ...
        return function () {
            ...
            return {
                errorLoading: function () {
                    return "خطایی در بارگزاری اطلاعات رخ داده است."
                }, inputTooLong: function (a) {
                    var b = a.input.length - a.maximum, c = "Please delete " + b + " character";
                    return 1 != b && (c += "s"), c
                }, inputTooShort: function (a) {
                    var b = a.minimum - a.input.length, c = "لطفا حداقل " + b + " حرف و یا بیشتر وارد کنید";
                    return c
                }, loadingMore: function () {
                    return "مشاهده نتایج بیشتر…"
                }, maximumSelected: function (a) {
                    var b = "شما حداکثر مجاز به انتخاب  " + a.maximum + " مورد هستید.";
