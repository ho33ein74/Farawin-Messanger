...
--
-- Host: localhost:3306
-- Generation Time: Jun 17, 2023 at 06:55 PM
...
--
-- Database: `hossein8_site_bluscript`
--
...
--
-- Table structure for table `tbl_admin_role_access`
--
...
INSERT INTO `tbl_banner` (`b_id`, `b_title`, `b_type`, `b_create_date`, `b_status`) VALUES
...
INSERT INTO `tbl_banner_image` (`bi_id`, `banner_id`, `bi_image`, `bi_description`, `bi_link`, `bi_status`) VALUES
...
--
-- Table structure for table `tbl_blog_related`
--
...
--
-- Table structure for table `tbl_blog_tag`
--
...
--
-- Table structure for table `tbl_contact_subject`
--

CREATE TABLE `tbl_contact_subject` (
  `cs_id` int NOT NULL,
...
--
-- Dumping data for table `tbl_contact_subject`
--
...
INSERT INTO `tbl_customer` (`c_id`, `customer_vids_id`, `c_name`, `c_family`, `c_display_name`, `c_mobile_num`, `c_phone_num`, `c_email`, `c_cart_no`, `c_birthday`, `province_id`, `city_id`, `c_arithmetic`, `c_image`, `c_about`, `c_registery_date`, `c_verification_code`, `c_status`) VALUES
...
--
-- Table structure for table `tbl_customer_bot`
--

CREATE TABLE `tbl_customer_bot` (
  `id` int NOT NULL,
...
--
-- Table structure for table `tbl_customer_document`
--

CREATE TABLE `tbl_customer_document` (
  `cd_id` int NOT NULL,
...
--
-- Table structure for table `tbl_customer_level`
--

CREATE TABLE `tbl_customer_level` (
  `cl_id` int NOT NULL,
...
--
-- Dumping data for table `tbl_customer_level`
--
...
CREATE TABLE `tbl_customer_reservations` (
  `cr_id` int NOT NULL,
...
--
-- Table structure for table `tbl_discounts_service`
--

CREATE TABLE `tbl_discounts_service` (
  `dcc_id` int NOT NULL,
  `dc_id` int NOT NULL,
  `service_id` int NOT NULL,
...
--
-- Table structure for table `tbl_discounts_staff`
--

CREATE TABLE `tbl_discounts_staff` (
  `ds_id` int NOT NULL,
  `dc_id` int NOT NULL,
...
--
-- Table structure for table `tbl_discounts_user_used`
--

CREATE TABLE `tbl_discounts_user_used` (
  `du_id` int NOT NULL,
  `user_id` int NOT NULL,
  `dc_id` int NOT NULL,
...
INSERT INTO `tbl_faq` (`id`, `type`, `question`, `answer`, `view`, `status`) VALUES
...
--
-- Table structure for table `tbl_faq_related`
--

CREATE TABLE `tbl_faq_related` (
  `fr_id` int NOT NULL,
...
--
-- Table structure for table `tbl_giftcart`
--

CREATE TABLE `tbl_giftcart` (
  `g_id` int NOT NULL,
...
INSERT INTO `tbl_images` (`i_id`, `post_id`, `i_type`, `i_image`, `i_alt`, `i_order`, `i_status`) VALUES
...
--
-- Table structure for table `tbl_methods_contacting`
--

CREATE TABLE `tbl_methods_contacting` (
  `mc_id` int NOT NULL,
...
--
-- Dumping data for table `tbl_methods_contacting`
--
...
--
-- Table structure for table `tbl_page_widget`
--
...
--
-- Dumping data for table `tbl_page_widget`
--
...
--
-- Table structure for table `tbl_redirect`
--

CREATE TABLE `tbl_redirect` (
...
--
-- Table structure for table `tbl_services_reservation`
--

CREATE TABLE `tbl_services_reservation` (
  `sre_id` int NOT NULL,
...
--
-- Table structure for table `tbl_services_reservation_log`
--

CREATE TABLE `tbl_services_reservation_log` (
  `idusr_activity` int NOT NULL,
  `admin_id` int UNSIGNED DEFAULT NULL,
...
--
-- Table structure for table `tbl_services_reservation_product`
--

CREATE TABLE `tbl_services_reservation_product` (
  `srp_id` int NOT NULL,
  `reservation_id` varchar(250) NOT NULL,
...
--
-- Table structure for table `tbl_services_reservation_staff`
--

CREATE TABLE `tbl_services_reservation_staff` (
  `os_id` int NOT NULL,
...
INSERT INTO `tbl_services_staff` (`r_id`, `staff_vids_id`, `name`, `expertise`, `description`, `no_sheba`, `no_card`, `image`, `score`, `status`) VALUES
...
--
-- Table structure for table `tbl_services_tag`
--

CREATE TABLE `tbl_services_tag` (
  `pt_id` int NOT NULL,
  `service_id` int NOT NULL,
  `tag_id` int NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf32;
...
--
-- Table structure for table `tbl_services_tariff`
--

CREATE TABLE `tbl_services_tariff` (
  `st_id` int NOT NULL,
  `service_id` int NOT NULL,
...
--
-- Dumping data for table `tbl_services_tariff`
--
...
--
-- Table structure for table `tbl_services_timing`
--

CREATE TABLE `tbl_services_timing` (
  `st_id` int NOT NULL,
  `service_id` int NOT NULL,
...
--
-- Dumping data for table `tbl_services_timing`
--
...
--
-- Table structure for table `tbl_services_timing_manage_day`
--

CREATE TABLE `tbl_services_timing_manage_day` (
  `sm_id` int NOT NULL,
  `service_id` int NOT NULL,
...
--
-- Dumping data for table `tbl_services_timing_manage_day`
--

INSERT INTO `tbl_services_timing_manage_day` (`sm_id`, `service_id`, `sm_title_day`, `sm_time_start`, `sm_time_end`, `sm_capacity`, `sm_description`, `sm_vip`, `sm_status`) VALUES
...
(99, 'float_contact_menu_popup_style', 'popup'),
...
CREATE TABLE `tbl_sidebar` (
  ...
  `s_name` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `s_link` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `s_counter_num` tinyint NOT NULL DEFAULT '0',
  `s_counter_num_type` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `s_icon` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
...
--
-- Table structure for table `tbl_sidebar_access_list`
--

CREATE TABLE `tbl_sidebar_access_list` (
  `sal_id` int NOT NULL,
...
--
-- Dumping data for table `tbl_sidebar_access_list`
--
...
INSERT INTO `tbl_slider` (`s_id`, `s_title`, `s_type`, `s_create_date`, `s_status`) VALUES
...
INSERT INTO `tbl_slider_image` (`si_id`, `slider_id`, `si_title`, `si_link`, `si_image`, `si_status`) VALUES
...
INSERT INTO `tbl_sources` (`so_id`, `title`, `link`, `image`, `user_id`, `count`, `date`, `date_edit`, `user_id_edit`, `status`) VALUES
...
--
-- Dumping data for table `tbl_storeroom`
--
...
--
-- Table structure for table `tbl_storeroom_product`
--

CREATE TABLE `tbl_storeroom_product` (
  `sr_id` int NOT NULL,
...
--
-- Table structure for table `tbl_storeroom_product_inventory`
--

CREATE TABLE `tbl_storeroom_product_inventory` (
  `spi_id` int NOT NULL,
  `storeroom_id` int NOT NULL,
  `product_id` int NOT NULL,
...
--
-- Table structure for table `tbl_vids`
--

CREATE TABLE `tbl_vids` (
  `vids_id` int NOT NULL,
...
--
-- Dumping data for table `tbl_vids`
--
...
ALTER TABLE `tbl_admin_activity`
  ADD PRIMARY KEY (`idusr_activity`) USING BTREE;
...
--
-- Indexes for table `tbl_admin_role_access`
--
ALTER TABLE `tbl_admin_role_access`
  ADD PRIMARY KEY (`aa_id`),
  ADD UNIQUE KEY `aa_id` (`aa_id`);
...
--
-- Indexes for table `tbl_blog_related`
--
ALTER TABLE `tbl_blog_related`
  ADD PRIMARY KEY (`br_id`);

--
-- Indexes for table `tbl_blog_tag`
--
...
--
-- Indexes for table `tbl_contact_subject`
--
ALTER TABLE `tbl_contact_subject`
...
--
-- Indexes for table `tbl_cost_type`
--
...
--
-- Indexes for table `tbl_customer_bot`
--
ALTER TABLE `tbl_customer_bot`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `id` (`id`);

--
-- Indexes for table `tbl_customer_document`
--
ALTER TABLE `tbl_customer_document`
  ADD PRIMARY KEY (`cd_id`);

--
-- Indexes for table `tbl_customer_level`
--
ALTER TABLE `tbl_customer_level`
  ADD PRIMARY KEY (`cl_id`);

--
-- Indexes for table `tbl_customer_reservations`
--
...
--
-- Indexes for table `tbl_discounts_service`
--
ALTER TABLE `tbl_discounts_service`
  ADD PRIMARY KEY (`dcc_id`);

--
-- Indexes for table `tbl_discounts_staff`
--
ALTER TABLE `tbl_discounts_staff`
  ADD PRIMARY KEY (`ds_id`);

--
-- Indexes for table `tbl_discounts_user_used`
--
ALTER TABLE `tbl_discounts_user_used`
...
ALTER TABLE `tbl_domains`
  ADD PRIMARY KEY (`domain_id`) USING BTREE,
  ADD KEY `udt_id` (`domain_id`) USING BTREE;
...
--
-- Indexes for table `tbl_faq_related`
--
ALTER TABLE `tbl_faq_related`
  ADD PRIMARY KEY (`fr_id`) USING BTREE;

--
-- Indexes for table `tbl_giftcart`
--
ALTER TABLE `tbl_giftcart`
...
--
-- Indexes for table `tbl_methods_contacting`
--
ALTER TABLE `tbl_methods_contacting`
...
--
-- Indexes for table `tbl_page_widget`
--
ALTER TABLE `tbl_page_widget`
...
--
-- Indexes for table `tbl_redirect`
--
ALTER TABLE `tbl_redirect`
  ADD PRIMARY KEY (`r_id`);

--
-- Indexes for table `tbl_searches`
--
ALTER TABLE `tbl_searches`
...
--
-- Indexes for table `tbl_services_related_blog`
--
ALTER TABLE `tbl_services_related_blog`
  ADD PRIMARY KEY (`srb_id`);

--
-- Indexes for table `tbl_services_reservation`
--
ALTER TABLE `tbl_services_reservation`
  ADD PRIMARY KEY (`sre_id`);

--
-- Indexes for table `tbl_services_reservation_log`
--
ALTER TABLE `tbl_services_reservation_log`
  ADD PRIMARY KEY (`idusr_activity`);

--
-- Indexes for table `tbl_services_reservation_product`
--
ALTER TABLE `tbl_services_reservation_product`
  ADD PRIMARY KEY (`srp_id`);

--
-- Indexes for table `tbl_services_reservation_staff`
--
ALTER TABLE `tbl_services_reservation_staff`
...
--
-- Indexes for table `tbl_services_tag`
--
ALTER TABLE `tbl_services_tag`
  ADD PRIMARY KEY (`pt_id`);

--
-- Indexes for table `tbl_services_tariff`
--
ALTER TABLE `tbl_services_tariff`
  ADD PRIMARY KEY (`st_id`);

--
-- Indexes for table `tbl_services_timing`
--
ALTER TABLE `tbl_services_timing`
  ADD PRIMARY KEY (`st_id`);

--
-- Indexes for table `tbl_services_timing_manage_day`
--
ALTER TABLE `tbl_services_timing_manage_day`
...
--
-- Indexes for table `tbl_sidebar_access_list`
--
ALTER TABLE `tbl_sidebar_access_list`
...
--
-- Indexes for table `tbl_storeroom_product`
--
ALTER TABLE `tbl_storeroom_product`
  ADD PRIMARY KEY (`sr_id`);

--
-- Indexes for table `tbl_storeroom_product_inventory`
--
ALTER TABLE `tbl_storeroom_product_inventory`
...
--
-- Indexes for table `tbl_vids`
--
ALTER TABLE `tbl_vids`
  ADD PRIMARY KEY (`vids_id`);
...
--
ALTER TABLE `tbl_admin_activity`
  MODIFY `idusr_activity` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tbl_admin_role`
--
ALTER TABLE `tbl_admin_role`
  MODIFY `ar_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `tbl_admin_role_access`
--
ALTER TABLE `tbl_admin_role_access`
  MODIFY `aa_id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tbl_banks`
--
ALTER TABLE `tbl_banks`
  MODIFY `b_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `tbl_banner`
--
ALTER TABLE `tbl_banner`
  MODIFY `b_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `tbl_banner_image`
--
ALTER TABLE `tbl_banner_image`
  MODIFY `bi_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- AUTO_INCREMENT for table `tbl_blog_related`
--
ALTER TABLE `tbl_blog_related`
  MODIFY `br_id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tbl_blog_tag`
--
ALTER TABLE `tbl_blog_tag`
  MODIFY `pt_id` int NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `tbl_branches`
  MODIFY `b_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1001;
...
--
ALTER TABLE `tbl_cities`
  MODIFY `ci_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=441;

--
-- AUTO_INCREMENT for table `tbl_color`
--
ALTER TABLE `tbl_color`
  MODIFY `color_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=141;
...
--
-- AUTO_INCREMENT for table `tbl_contact_subject`
--
ALTER TABLE `tbl_contact_subject`
  MODIFY `cs_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- AUTO_INCREMENT for table `tbl_cost_type`
--
ALTER TABLE `tbl_cost_type`
  MODIFY `ct_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT for table `tbl_customer_bot`
--
ALTER TABLE `tbl_customer_bot`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tbl_customer_document`
--
ALTER TABLE `tbl_customer_document`
  MODIFY `cd_id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tbl_customer_level`
--
ALTER TABLE `tbl_customer_level`
  MODIFY `cl_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `tbl_customer_reservations`
--
ALTER TABLE `tbl_customer_reservations`
...
--
ALTER TABLE `tbl_discounts`
  MODIFY `dc_id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tbl_discounts_service`
--
ALTER TABLE `tbl_discounts_service`
  MODIFY `dcc_id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tbl_discounts_staff`
--
ALTER TABLE `tbl_discounts_staff`
  MODIFY `ds_id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tbl_discounts_user_used`
--
ALTER TABLE `tbl_discounts_user_used`
  MODIFY `du_id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tbl_domains`
--
ALTER TABLE `tbl_domains`
  MODIFY `domain_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
...
--
-- AUTO_INCREMENT for table `tbl_faq_related`
--
ALTER TABLE `tbl_faq_related`
  MODIFY `fr_id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tbl_giftcart`
--
ALTER TABLE `tbl_giftcart`
...
--
ALTER TABLE `tbl_icons`
  MODIFY `i_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `tbl_images`
--
ALTER TABLE `tbl_images`
  MODIFY `i_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
...
--
ALTER TABLE `tbl_link`
  MODIFY `l_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `tbl_methods_contacting`
--
ALTER TABLE `tbl_methods_contacting`
  MODIFY `mc_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
...
--
-- AUTO_INCREMENT for table `tbl_page_widget`
--
ALTER TABLE `tbl_page_widget`
  MODIFY `ip_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `tbl_pettycash`
  MODIFY `p_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1001;

--
-- AUTO_INCREMENT for table `tbl_provinces`
--
ALTER TABLE `tbl_provinces`
  MODIFY `pro_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
...
--
-- AUTO_INCREMENT for table `tbl_redirect`
--
ALTER TABLE `tbl_redirect`
  MODIFY `r_id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tbl_searches`
--
ALTER TABLE `tbl_searches`
...
--
-- AUTO_INCREMENT for table `tbl_services_related_blog`
--
ALTER TABLE `tbl_services_related_blog`
  MODIFY `srb_id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tbl_services_reservation`
--
ALTER TABLE `tbl_services_reservation`
  MODIFY `sre_id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tbl_services_reservation_log`
--
ALTER TABLE `tbl_services_reservation_log`
  MODIFY `idusr_activity` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tbl_services_reservation_product`
--
ALTER TABLE `tbl_services_reservation_product`
  MODIFY `srp_id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tbl_services_reservation_staff`
--
ALTER TABLE `tbl_services_reservation_staff`
...
--
-- AUTO_INCREMENT for table `tbl_services_tag`
--
ALTER TABLE `tbl_services_tag`
  MODIFY `pt_id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tbl_services_tariff`
--
ALTER TABLE `tbl_services_tariff`
  MODIFY `st_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `tbl_services_timing`
--
ALTER TABLE `tbl_services_timing`
  MODIFY `st_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `tbl_services_timing_manage_day`
--
ALTER TABLE `tbl_services_timing_manage_day`
  MODIFY `sm_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `tbl_sidebar`
  MODIFY `s_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=100;

--
-- AUTO_INCREMENT for table `tbl_sidebar_access_list`
--
ALTER TABLE `tbl_sidebar_access_list`
  MODIFY `sal_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=225;
...
--
ALTER TABLE `tbl_slider_image`
  MODIFY `si_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `tbl_sources`
--
ALTER TABLE `tbl_sources`
  MODIFY `so_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT for table `tbl_storeroom_product`
--
ALTER TABLE `tbl_storeroom_product`
  MODIFY `sr_id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tbl_storeroom_product_inventory`
--
ALTER TABLE `tbl_storeroom_product_inventory`
  MODIFY `spi_id` int NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `tbl_vids`
--
ALTER TABLE `tbl_vids`
  MODIFY `vids_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
