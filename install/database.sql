...
INSERT INTO `tbl_page` (`p_id`, `type`, `link`, `readonly_link`, `removable`, `writer`, `title`, `main_tag`, `metaDescription`, `cover`, `data_item`, `description`, `view`, `date_created`, `time`, `p_status`) VALUES
	...
	(5, 'sub_page', 'vipAccount', 1, 0, 1, 'عضویت ویژه', 'عضویت ویژه', 'لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است.', NULL, NULL, '&lt;p&gt;لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد. کتابهای زیادی در شصت و سه درصد گذشته، حال و آینده شناخت فراوان جامعه و متخصصان را می طلبد تا با نرم افزارها شناخت بیشتری را برای طراحان رایانه ای علی الخصوص طراحان خلاقی و فرهنگ پیشرو در زبان فارسی ایجاد کرد. در این صورت می توان امید داشت که تمام و دشواری موجود در ارائه راهکارها و شرایط سخت تایپ به پایان رسد وزمان مورد نیاز شامل حروفچینی دستاوردهای اصلی و جوابگوی سوالات پیوسته اهل دنیای موجود طراحی اساسا مورد استفاده قرار گیرد.&lt;/p&gt;\r\n', 0, '1400/07/07', '22:26', 1),
...
INSERT INTO `tbl_template` (`t_id`, `t_part`, `t_href`, `t_title`, `t_show_title`, `t_description`, `t_help_txt`, `t_image`, `t_theme`, `t_is_custom`, `t_is_default_widget`, `t_status`) VALUES
	(22, 'dashboard', 'clock2', 'ساعت آنالوگ 2', 0, NULL, 'نمایش ساعت فعلی', 'clock2.png', 'default', 0, 0, 1),
	(19, 'dashboard', 'custom_wul4Xc8D8t', 'تست بدون عنوان', 0, 'لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد. کتابهای زیادی در شصت و سه درصد گذشته، حال و آینده شناخت فراوان جامعه و متخصصان را می طلبد تا با نرم افزارها شناخت بیشتری را برای طراحان رایانه ای علی الخصوص طراحان خلاقی و فرهنگ پیشرو در زبان فارسی ایجاد کرد. در این صورت می توان امید داشت که تمام و دشواری موجود در ارائه راهکارها و شرایط سخت تایپ به پایان رسد وزمان مورد نیاز شامل حروفچینی دستاوردهای اصلی و جوابگوی سوالات پیوسته اهل دنیای موجود طراحی اساسا مورد استفاده قرار گیرد.', NULL, NULL, 'default', 1, 0, 1),
	(16, 'dashboard', 'last_users_register', 'آخرین مشتریان ثبت شده', 0, NULL, 'در این قسمت لیست آخرین مشتریان ثبت شده نمایش داده می شود.', 'last-user-register.png', 'default', 0, 1, 1),
	(17, 'dashboard', 'last_blog_article', 'آخرین مطالب وبلاگ', 0, NULL, 'در این قسمت لیست جدیدترین اخبار و اطلاعیه های سامانه نمایش داده می شود.', 'last-blog-article.png', 'default', 0, 1, 1),
	(14, 'dashboard', 'chart_courses_users_this_month', 'نمودار شرکت کنندگان دوره ها در ماه', 0, NULL, 'در این قسمت فروش ثبت شده در هر ماه به صورت روزانه نمایش داده می شود. برای مشاهده نمودار در حالات مختلف و گرفتن خروجی می توانید از دکمه های سمت راست استفاده نمایید. همچنین برای مشاهده بازه های مختلف می توانید به بخش گزارش مالی مراجعه نمایید.', 'courses-sale-chart.png', 'default', 0, 1, 1),
	(15, 'dashboard', 'last_activity', 'آخرین فعالیت های شما', 0, NULL, 'در این قسمت لیست آخرین فعالیت هایی که انجام داده اید نمایش داده می شود. برای مشاهده لیست کامل فعالیت ها می توانید به بخش سوابق فعالیت کارکنان مراجعه نمایید.', 'last-activity.png', 'default', 0, 1, 1),
	(13, 'dashboard', 'chart_reservation_this_month', 'نمودار نوبت‌های رزرو شده در ماه', 0, NULL, 'در این قسمت تعمیرات ثبت شده در هر ماه به صورت روزانه نمایش داده می شود. برای مشاهده نمودار در حالات مختلف و گرفتن خروجی می توانید از دکمه های سمت راست استفاده نمایید. همچنین برای مشاهده بازه های مختلف می توانید به بخش گزارش مالی مراجعه نمایید.', 'reservation-chart.png', 'default', 0, 1, 1),
	(12, 'dashboard', 'credit_sms_panel', 'اعتبار پنل پیامک', 0, NULL, 'در این قسمت تعداد روزهای باقیمانده از اشتراک شما نمایش داده می شود. برای تمدید/ارتقا اشتراک می توانید از دکمه اطلاعات بیشتر استفاده نمایید.', 'credit-sms-panel.png', 'default', 0, 1, 1),
	(5, 'main', 'banner', 'بنر تبلیغاتی', 0, NULL, NULL, NULL, 'default', 0, 0, 1),
	(4, 'main', 'service', 'خدمات', 0, NULL, NULL, NULL, 'default', 0, 0, 1),
	(6, 'main', 'comment', 'نظرات مشتریان', 0, NULL, NULL, NULL, 'default', 0, 0, 1),
	(3, 'main', 'blog', 'مطالب وبلاگ', 0, NULL, NULL, NULL, 'default', 0, 0, 1),
	(7, 'main', 'socialmedia', 'شبکه های اجتماعی', 0, NULL, NULL, NULL, 'default', 0, 0, 1),
	(8, 'main', 'textArea', 'متن', 0, NULL, NULL, NULL, 'default', 0, 0, 1),
	(9, 'dashboard', 'count_reservation_complete_this_month', 'تعداد نوبت‌های انجام شده ماه', 0, NULL, 'در این قسمت تعداد فروش های ثبت شده در هر ماه نمایش داده می شود. برای مشاهده لیست کامل فروش می توانید از دکمه اطلاعات بیشتر استفاده نمایید.', 'courses-sale.png', 'default', 0, 1, 1),
	(10, 'dashboard', 'count_reservation_this_month', 'تعداد نوبت‌های ماه', 0, NULL, 'در این قسمت تعداد تعمیرات ثبت شده در هر ماه نمایش داده می شود.  برای مشاهده لیست کامل تعمیرات می توانید از دکمه اطلاعات بیشتر استفاده نمایید.', 'reservation-count.png', 'default', 0, 1, 1),
	(11, 'dashboard', 'count_users_this_month', 'تعداد کابران ماه', 0, NULL, 'در این قسمت تعداد مشتری های جدید ثبت شده در هر ماه نمایش داده می شود. برای مشاهده لیست کامل مشتریان می توانید از دکمه اطلاعات بیشتر استفاده نمایید.', 'customer.png', 'default', 0, 1, 1),
	(1, 'main', 'slider', 'اسلایدر', 0, NULL, NULL, NULL, 'default', 0, 0, 1),
	(21, 'dashboard', 'clock', 'ساعت آنالوگ', 0, NULL, 'نمایش ساعت فعلی', 'clock.png', 'default', 0, 0, 1);
