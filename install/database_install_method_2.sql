...
-- Dumping data for table reservation.tbl_blog: ~3 rows (approximately)
...
-- Dumping data for table reservation.tbl_faq: ~2 rows (approximately)
...
INSERT IGNORE INTO `tbl_page_widget` (`ip_id`, `page_id`, `template_id`, `ip_title`, `ip_order`, `ip_content`, `ip_status`) VALUES
	...
	(4, 2, 6, 'شبکه های اجتماعی', 5, 'a:3:{s:4:"link";s:1:"#";s:10:"link_title";s:47:"مشاهده پست های اینستاگرام";s:11:"description";s:115:"ما هر روز کلی مطالب آموزشی جالب در اینستاگراممون منتشر می‌کنیم";}', 1),
...
INSERT IGNORE INTO `tbl_settings` (`id`, `key`, `value`, `default_value`) VALUES
	(1, 'root', 'root_path', 'root_path'),
	(2, 'admin_path', 'manage', 'manage'),
	(3, 'show_error', '0', '0'),
	(4, 'site', 'web_title', 'اسکریپت رزرواسیون سالن زیبایی ونسا'),
	(5, 'meta_description', '', ''),
	(6, 'meta_keyword', '', ''),
	...
	(9, 'channel_blog', '', ''),
	(10, 'bot_token', '', ''),
	(11, 'logo', '1679993228_2454_logo.svg', '1679993228_2454_logo.svg'),
	(12, 'logo_square', '1679993414_7401_logo-min.svg', '1679993414_7401_logo-min.svg'),
	(13, 'location', '', ''),
	(14, 'address', '', ''),
	(15, 'site_short_name', 'web_title', 'اسکریپت رزرواسیون سالن زیبایی ونسا'),
	(16, 'factor_sales', '', ''),
	(17, 'google', '', ''),
	(18, 'theme_color', '#e81124', '#e81124'),
	(19, 'legal_name', 'web_title', 'اسکریپت رزرواسیون سالن زیبایی ونسا'),
	(20, 'footer_about', 'متن پیش فرض درباره ما که می توانید از بخش پیکربندی در قسمت تنظیمات آن را تغییر دهید', 'متن پیش فرض درباره ما که می توانید از بخش پیکربندی در قسمت تنظیمات آن را تغییر دهید'),
	(21, 'customJS', '', ''),
	(22, 'sms_status', '0', '0'),
	(23, 'sms_api_key', '', ''),
	(24, 'sms_secret_key', '', ''),
	(25, 'sms_site', 'sms_ir', 'sms_ir'),
	(26, 'sms_number', '', ''),
	(27, 'sms_pattern_code', '', ''),
	...
	(32, 'economic_code', '', ''),
	(33, 'postal_code', '', ''),
	(34, 'favicon', '1679993744_337_fav.png', '1679993744_337_fav.png'),
	(35, 'field_of_activity', 'سالن زیبایی', 'سالن زیبایی'),
	(36, 'business_type', '1', '1'),
	(37, 'province', '', ''),
	(38, 'city', '', ''),
	(39, 'login_admin_background', '1667072402_9794_adam-winger-KVVjmb3IIL8-unsplash.jpg', '1667072402_9794_adam-winger-KVVjmb3IIL8-unsplash.jpg'),
	(40, 'cookie_duration', '7', '7'),
	(41, 'sms_template_for_forget_password_admin', '', ''),
	(42, 'sms_template_login', '', ''),
	(43, 'offline_mode', '1', '1'),
	(44, 'phone', '', ''),
	(45, 'blog_item_per_page', '6', '6'),
	(46, 'theme', 'default', 'default'),
	(47, 'customJS_position', 'top', 'top'),
	(48, 'site_public', 'index', 'index'),
	(49, 'samandehi_link', '', ''),
	(50, 'samandehi_image', '', ''),
	(51, 'enamad_link', '', ''),
	(52, 'enamad_image', '', ''),
	(53, 'zarinpal_link', '', ''),
	(54, 'zarinpal_image', '', ''),
	(55, 'logo_dark', '1679993220_3112_logo dark.svg', '1679993220_3112_logo dark.svg'),
	(56, 'logo_square_dark', '1679993439_9243_logo-min-dark.svg', '1679993439_9243_logo-min-dark.svg'),
	(57, 'google_captcha_status', '0', '0'),
	(58, 'copyright', 'کلیه حقوق مادی و معنوی برای این سایت محفوظ می باشد.', 'کلیه حقوق مادی و معنوی برای این سایت محفوظ می باشد.'),
	(59, 'notification', '0', '0'),
	(60, 'notification_text_position', 'center', 'center'),
	(61, 'notification_message', '', ''),
	(62, 'development_mode', '0', '0'),
	(63, 'development_mode_text', 'در حال تغییراتی بر روی سایت هستیم و به زودی باز خواهیم گشت', 'در حال تغییراتی بر روی سایت هستیم و به زودی باز خواهیم گشت'),
	(64, 'admin_ip_lock', '0', '0'),
	(65, 'admin_ip', '', ''),
	(66, 'notification_text_color', '#ffffff', '#ffffff'),
	(67, 'notification_background_color', '#5049f6', '#5049f6'),
	(68, 'footer_logo', '1', '1'),
	(69, 'active_wallet', '0', '0'),
	(70, 'service_item_per_page', '6', '6'),
	(71, 'management_name', '', ''),
	(72, 'comment_item_per_page', '15', '15'),
	(73, 'comment_limit_for_user', '2', '2'),
	(74, 'comment_confirm_method', 'admin', 'admin'),
	(75, 'comment_reply_button', '1', '1'),
	(76, 'comment_show_for_login_user', '0', '0'),
	(77, 'comment_word_check', '0', '0'),
	(78, 'comment_word_forbidden', '', ''),
	(79, 'dashboard_default', '[{"ratio": "3-3-3-3", "columns": [[{"title": "تعداد نوبت‌های ماه", "widget": "count_reservation_this_month"}], [{"title": "تعداد کابران ماه", "widget": "count_users_this_month"}], [{"title": "اعتبار پنل پیامک", "widget": "credit_sms_panel"}]]}, {"ratio": "9-3", "columns": [[{"title": "نمودار نوبت‌های رزرو شده در ماه", "widget": "chart_reservation_this_month"}], [{"title": "ساعت آنالوگ", "widget": "clock"}]]}, {"ratio": "6-6", "columns": [[{"title": "آخرین فعالیت های شما", "widget": "last_activity"}], [{"title": "آخرین مشتریان ثبت شده", "widget": "last_users_register"}]]}, {"ratio": "12", "columns": [[{"title": "آخرین مطالب وبلاگ", "widget": "last_blog_article"}]]}]', '[{"ratio": "3-3-3-3", "columns": [[{"title": "تعداد نوبت‌های ماه", "widget": "count_reservation_this_month"}], [{"title": "تعداد کابران ماه", "widget": "count_users_this_month"}], [{"title": "اعتبار پنل پیامک", "widget": "credit_sms_panel"}]]}, {"ratio": "9-3", "columns": [[{"title": "نمودار نوبت‌های رزرو شده در ماه", "widget": "chart_reservation_this_month"}], [{"title": "ساعت آنالوگ", "widget": "clock"}]]}, {"ratio": "6-6", "columns": [[{"title": "آخرین فعالیت های شما", "widget": "last_activity"}], [{"title": "آخرین مشتریان ثبت شده", "widget": "last_users_register"}]]}, {"ratio": "12", "columns": [[{"title": "آخرین مطالب وبلاگ", "widget": "last_blog_article"}]]}]'),
	(80, 'csrf_token_name', 'unix_csrf_token', 'unix_csrf_token'),
	(81, 'float_contact', '0', '0'),
	(82, 'float_contact_color', '#ff5c62', '#ff5c62'),
	(83, 'float_contact_position', 'right', 'right'),
	(84, 'float_contact_size', 'large', 'large'),
	(85, 'float_contact_text', 'تماس با ما', 'تماس با ما'),
	(86, 'float_contact_icons_animation_speed', '3000', '3000'),
	(87, 'float_contact_icons_animation_pause', '2000', '2000'),
	(88, 'float_contact_online_badge', '1', '1'),
	(89, 'float_contact_menu_backdrop', '1', '1'),
	(90, 'float_contact_menu_size', 'normal', 'normal'),
	(91, 'float_contact_menu_header_close_btn_bg_color', '#008749', '#008749'),
	(92, 'float_contact_menu_header_close_btn_color', '#ffffff', '#ffffff'),
	(93, 'float_contact_menu_show_header_close_btn', '1', '1'),
	(94, 'float_contact_menu_show_header', '1', '1'),
	(95, 'float_contact_menu_header_text', 'ما را در شبکه های اجتماعی دنبال کنید', 'ما را در شبکه های اجتماعی دنبال کنید'),
	(96, 'float_contact_menu_sub_header_text', '', ''),
	(97, 'float_contact_items_icon_type', 'rounded', 'rounded'),
	(98, 'float_contact_popup_animation', 'scale', 'scale'),
	(99, 'float_contact_menu_popup_style', 'popup', 'popup'),
	(100, 'float_contact_sidebar_animation', 'elastic', 'elastic'),
	(101, 'float_contact_menu_items_animation', 'fromaside', 'fromaside'),
	(102, 'float_contact_mode_select_options', 'regular', 'regular'),
	(103, 'float_contact_menu_click_away', '1', '1'),
	(104, 'bot_status', '0', '0'),
	(105, 'license_info', '', '');
